...
public:
    ...
    /*!
     * \brief The parameter for the PNG writes, e.g. compression quality.
     */
    ...
    /*!
     * \brief The Parameter for the JPEG writes, e.g. compression quality.
     */
     ...
     *
     * \param[in] filePath    The path of the file to store the image to as an UTF-8 encoded string.
     * \param[in] imageToSave The image to save.
     *
     * \throws ImageFormatNotSupportedException A file type isn't supported for this image pixel format
     ...
     *
     * \since 1.0
     * \since 1.2 Will throw ImageFormatNotSupportedException if imageToSave has a packed pixel format
