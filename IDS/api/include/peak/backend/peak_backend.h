...
#    define PEAK_NO_DISCARD [[nodiscard]]
#    define PEAK_MAYBE_UNUSED [[maybe_unused]]
#else
#    ifdef _MSC_VER
#        define PEAK_NO_DISCARD _Check_return_
#        define PEAK_MAYBE_UNUSED
#    elif defined(__clang__) || defined(__GNUC__) || defined(__GNUG__)
#        define PEAK_NO_DISCARD __attribute__((warn_unused_result))
#        define PEAK_MAYBE_UNUSED __attribute__((unused))
#    else
#        define PEAK_NO_DISCARD
#        define PEAK_MAYBE_UNUSED
#    endif
#endif
...
enum PEAK_RETURN_CODE_t
{
    ...
    PEAK_RETURN_CODE_CTI_LOADING_ERROR,
    PEAK_RETURN_CODE_IO,
    PEAK_RETURN_CODE_NO_DATA
...
struct PEAK_FILE_ADAPTER;
/*! The type of file adapter handles. */
typedef struct PEAK_FILE_ADAPTER* PEAK_FILE_ADAPTER_HANDLE;
...
/*! The type of interface list changedcallbacks */
typedef void(PEAK_CALL_CONV* PEAK_INTERFACE_LIST_CHANGED_CALLBACK)(void* context);
...
/*! The type of interface list changed callback handles */
typedef PEAK_INTERFACE_LIST_CHANGED_CALLBACK* PEAK_INTERFACE_LIST_CHANGED_CALLBACK_HANDLE;

enum PEAK_DEVICE_RECONNECT_ERROR_t
{
    /*! No error occurred */
    PEAK_DEVICE_RECONNECT_OPERATION_NO_ERROR = 0x0,
    /*! Indicates that the TL could not restart the remote device acquisition. */
    PEAK_DEVICE_RECONNECT_OPERATION_REMOTE_DEVICE_ACQUISITION_RESTART_ERROR = 0x1000000,
    ...
    PEAK_DEVICE_RECONNECT_OPERATION_REMOTE_DEVICE_ACQUISITION_RESTART_PAYLOAD_SIZE_LARGER_THAN_BUFFERS = 0x1000001,
    /*! Indicates that the TL could not restore the remote devices configuration. */
    PEAK_DEVICE_RECONNECT_OPERATION_REMOTE_DEVICE_CONFIGURATION_RESTORE_ERROR = 0x2000000,
};
typedef uint32_t PEAK_DEVICE_RECONNECT_ERROR_FLAGS;

/*! Reconnect information signaling the state of the Device after it has been reconnected. */
typedef struct
{
    /*! True if the remote device acquisition is currently running */
    PEAK_BOOL8 IsRemoteDeviceAcquisitionRunning;
    /*! True if the configuration of the remote device has been restored */
    PEAK_BOOL8 IsRemoteDeviceConfigurationRestored;
    /*! Reserved */
    PEAK_BOOL8 Reserved[6];

    /*! Error flags indicating whether some operation failed during the reconnect */
    PEAK_DEVICE_RECONNECT_ERROR_FLAGS ErrorFlags;

    /*! Reserved */
    uint8_t Reserved2[20];
} PEAK_DEVICE_RECONNECT_INFORMATION;
...
typedef void(PEAK_CALL_CONV* PEAK_DEVICE_RECONNECTED_CALLBACK)(PEAK_DEVICE_DESCRIPTOR_HANDLE reconnectedDevice,
...
typedef void(PEAK_CALL_CONV* PEAK_DEVICE_DISCONNETED_CALLBACK)(
    PEAK_DEVICE_DESCRIPTOR_HANDLE disconnectedDevice, void* context);
/*! The type of device list changed callbacks */
typedef void(PEAK_CALL_CONV* PEAK_DEVICE_LIST_CHANGED_CALLBACK)(void* context);
...
typedef PEAK_DEVICE_RECONNECTED_CALLBACK* PEAK_DEVICE_RECONNECTED_CALLBACK_HANDLE;
/*! The type of device disconnected callback handles */
typedef PEAK_DEVICE_DISCONNETED_CALLBACK* PEAK_DEVICE_DISCONNECTED_CALLBACK_HANDLE;
...
typedef PEAK_DEVICE_LIST_CHANGED_CALLBACK* PEAK_DEVICE_LIST_CHANGED_CALLBACK_HANDLE;
...
/*!
 * \brief Initializes the IDS peak genericAPI library.
 *
...
/*!
 * \brief Closes the IDS peak genericAPI library and cleans up any resources that are still in use.
 *
...
/*!
 * \brief Checks if the IDS peak genericAPI library is initialized.
 *
 * \param[out] isInitialized Flag telling whether the IDS peak genericAPI library is initialized.
 *
 ...
 * \return PEAK_RETURN_CODE_CTI_LOADING_ERROR Error on loading the cti
 * \return PEAK_RETURN_CODE_ERROR An internal error has occurred.
 *
 * \since 1.0
 */
...
/*!
 * \brief Registers a callback signaling a reconnected device at the given interface.
 *
 * \param[in] interfaceHandle The interface.
 * \param[in] callback The callback.
 * \param[in] callbackContext The callback context.
 ...
 * \return PEAK_RETURN_CODE_INVALID_HANDLE interfaceHandle is invalid
 * \return PEAK_RETURN_CODE_INVALID_ARGUMENT callback and/or callbackHandle are/is a null pointer
 * \return PEAK_RETURN_CODE_NOT_AVAILABLE reconnect callback is not available
 * \return PEAK_RETURN_CODE_ERROR An internal error has occurred.
 *
 * \since 1.7
 */
PEAK_C_API PEAK_Interface_RegisterDeviceReconnectedCallback(PEAK_INTERFACE_HANDLE interfaceHandle,
    PEAK_DEVICE_RECONNECTED_CALLBACK callback, void* callbackContext,
    PEAK_DEVICE_RECONNECTED_CALLBACK_HANDLE* callbackHandle);
/*!
 * \brief Unregisters the device-reconnected callback with the given handle from the given interface.
 *
 * \param[in] interfaceHandle The interface.
 * \param[in] callbackHandle The handle of the callback to unregister.
 *
 ...
 * \since 1.7
 */
PEAK_C_API PEAK_Interface_UnregisterDeviceReconnectedCallback(
    PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_RECONNECTED_CALLBACK_HANDLE callbackHandle);
/*!
 * \brief Registers a callback signaling a disconnected device that is now waiting to be reconnected
 ...
 * \since 1.7
 */
PEAK_C_API PEAK_Interface_RegisterDeviceDisconnectedCallback(PEAK_INTERFACE_HANDLE interfaceHandle,
    PEAK_DEVICE_DISCONNETED_CALLBACK callback, void* callbackContext,
    PEAK_DEVICE_DISCONNECTED_CALLBACK_HANDLE* callbackHandle);
/*!
 * \brief Unregisters the device disconnected callback with the given handle from the given interface.
 *
 * \param[in] interfaceHandle The interface.
 * \param[in] callbackHandle The handle of the callback to unregister.
 *
 ...
 * \since 1.7
 */
PEAK_C_API PEAK_Interface_UnregisterDeviceDisconnectedCallback(
    PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_DISCONNECTED_CALLBACK_HANDLE callbackHandle);
...
/*!
 * \brief Registers a callback signaling a change in the device list at the given interface.
 *
 * \param[in] interfaceHandle The interface.
 * \param[in] callback The callback.
 * \param[in] callbackContext The callback context.
 ...
 * \since 1.7
 */
PEAK_C_API PEAK_Interface_RegisterDeviceListChangedCallback(PEAK_INTERFACE_HANDLE interfaceHandle,
    PEAK_DEVICE_LIST_CHANGED_CALLBACK callback, void* callbackContext, PEAK_DEVICE_LIST_CHANGED_CALLBACK_HANDLE* callbackHandle);
/*!
 * \brief Unregisters the device-list-changed callback with the given handle from the given interface.
 *
 * \param[in] interfaceHandle The interface.
 * \param[in] callbackHandle The handle of the callback to unregister.
 *
 ...
 * \since 1.7
 */
PEAK_C_API PEAK_Interface_UnregisterDeviceListChangedCallback(
    PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LIST_CHANGED_CALLBACK_HANDLE callbackHandle);
 ...
 * "TLParamsLocked" to a value of 1.
 ...
 * timeout is exceeded.
 *
 * Additionally the blocking wait can be aborted by calling \ref PEAK_DataStream_KillWait.
 *
 * \note After the buffer has been received it has to be requeued using
 *       \ref PEAK_DataStream_QueueBuffer once the buffer data has been copied or processed.
 ...
 *
 * Kills one call to \ref PEAK_DataStream_WaitForFinishedBuffer or queues the kill request
 * to be applied to the next call to \ref PEAK_DataStream_WaitForFinishedBuffer immediately.
 *
 * \param[in] dataStreamHandle The data stream.
 *
 * \return PEAK_RETURN_CODE_SUCCESS Everything was fine
 ...
 * happen, see \ref PEAK_DataStream_AnnounceBuffer.
 *
 * \param[in] dataStreamHandle The data stream.
 ...
 * Starts the acquisition engine on the host side. The acquisition on the
 * remote device needs to be started separately using the "AcquisitionStart"
 * command node. Once \p numToAcquire buffers are received all subsequent buffers
 * will be discarded. \ref PEAK_DataStream_StopAcquisition still has to be called
 * explicitly.
 *
 * The acquisition engine depends on the payload size value not changing
 * between announcing the buffers to the data stream and while the
...
/*!
 * \brief Asks the given buffer whether it has parts.
 *
 * \param[in] bufferHandle The buffer.
 * \param[out] hasParts A flag telling whether the buffer has parts.
 *
 * \return PEAK_RETURN_CODE_SUCCESS Everything was fine
 * \return PEAK_RETURN_CODE_INVALID_HANDLE bufferHandle is invalid
 * \return PEAK_RETURN_CODE_INVALID_ARGUMENT hasParts is a null pointer
 * \return PEAK_RETURN_CODE_ERROR An internal error has occurred.
 *
 * \since 1.7.4
 */
PEAK_C_API PEAK_Buffer_GetHasParts(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8* hasParts);
/*!
...
/*!
 * \brief Destroys the given buffer chunk.
 *
 * \param[in] bufferChunkHandle The buffer chunk.
 *
 * \return PEAK_RETURN_CODE_SUCCESS Everything was fine
 ...
 * \since 1.5
 */
PEAK_C_API PEAK_BufferChunk_Destruct(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle);
...
/*!
 * \brief Destroys the given buffer part.
 *
 * \param[in] bufferPartHandle The buffer part.
 *
 * \return PEAK_RETURN_CODE_SUCCESS Everything was fine
 ...
 * \since 1.5
 */
PEAK_C_API PEAK_BufferPart_Destruct(PEAK_BUFFER_PART_HANDLE bufferPartHandle);
...
/*!
 * \brief Tells the given node map to try to find a node with the given name.
 *
 * \param[in] nodeMapHandle The node map.
 * \param[in] nodeName The name of the node to find.
 * \param[in] nodeNameSize The size of the name.
 * \param[out] nodeHandle The found node or NULL if not found.
 *
 * \return PEAK_RETURN_CODE_SUCCESS Everything was fine
 * \return PEAK_RETURN_CODE_INVALID_HANDLE nodeMapHandle is invalid
 * \return PEAK_RETURN_CODE_INVALID_ARGUMENT nodeName and/or nodeHandle are/is a null pointer
 ...
 * \since 1.10
 */
PEAK_C_API PEAK_NodeMap_TryFindNode(
    PEAK_NODE_MAP_HANDLE nodeMapHandle, const char* nodeName, size_t nodeNameSize, PEAK_NODE_HANDLE* nodeHandle);
/*!
 ...
 *
 * \return PEAK_RETURN_CODE_SUCCESS Everything was fine
 * \return PEAK_RETURN_CODE_IO A communication error has occured, e.g. when the device is disconnected.
 * \return PEAK_RETURN_CODE_INVALID_ARGUMENT accessStatus is a null pointer
 * \return PEAK_RETURN_CODE_INVALID_HANDLE nodeHandle is invalid
 * \return PEAK_RETURN_CODE_ERROR An internal error has occurred.
 *
 ...
 *
 * \return PEAK_RETURN_CODE_SUCCESS Everything was fine
 * \return PEAK_RETURN_CODE_IO A communication error has occured, e.g. when the device gets unexpectedly disconnected during the update process.
...
/*!
 * \brief Asks the given enumeration node whether it has an entry with the given symbolic value
 *
 * \param[in] enumerationNodeHandle The enumeration node.
 * \param[in] symbolicValue The symbolic value.
 * \param[in] symbolicValueSize The size of the symbolic value.
 * \param[out] hasEntry The returned bool
 *
 * \return PEAK_RETURN_CODE_SUCCESS Everything was fine
 * \return PEAK_RETURN_CODE_IO A communication error has occured, e.g. when the device gets unexpectedly disconnected during the update process.
 * \return PEAK_RETURN_CODE_INVALID_ARGUMENT symbolic value and/or hasEntry are/is a null pointer.
 * \return PEAK_RETURN_CODE_INVALID_HANDLE enumerationNodeHandle is invalid
 * \return PEAK_RETURN_CODE_ERROR An internal error has occurred.
 *
 * \since 1.10
 */
PEAK_C_API PEAK_EnumerationNode_GetHasEntryBySymbolicValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle,
    const char* symbolicValue, size_t symbolicValueSize, PEAK_BOOL8* hasEntry);

/*!
 * \brief Asks the given enumeration node whether it has an entry with the given value
 *
 * \param[in] enumerationNodeHandle The enumeration node.
 * \param[in] value The value.
 * \param[out] hasEntry The returned bool
 ...
 * \since 1.10
 */
PEAK_C_API PEAK_EnumerationNode_GetHasEntryByValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle,
    int64_t value, PEAK_BOOL8* hasEntry);

/*!
 * \brief Tells the given enumeration node to find an entry with the given symbolic value.
 *
 * \param[in] enumerationNodeHandle The enumeration node.
 * \param[in] symbolicValue The symbolic value.
 * \param[in] symbolicValueSize The size of the symbolic value.
...
/*!
 * \brief Tells the given enumeration node to find an entry with the given value.
 *
 * \param[in] enumerationNodeHandle The enumeration node.
 * \param[in] value The value.
 * \param[out] enumerationEntryNodeHandle The found entry.
...
/*!
 * \brief Tells the given enumeration node to try to find an entry with the given symbolic value.
 *
 * \param[in] enumerationNodeHandle The enumeration node.
 * \param[in] symbolicValue The symbolic value.
 * \param[in] symbolicValueSize The size of the symbolic value.
 * \param[out] enumerationEntryNodeHandle The found entry or NULL if not found.
 *
 * \return PEAK_RETURN_CODE_SUCCESS Everything was fine
 * \return PEAK_RETURN_CODE_INVALID_HANDLE enumerationNodeHandle is invalid
 * \return PEAK_RETURN_CODE_INVALID_ARGUMENT symbolicValue and/or enumerationEntryNodeHandle are/is a null pointer
 ...
 * \since 1.10
 */
PEAK_C_API PEAK_EnumerationNode_TryFindEntryBySymbolicValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle,
    const char* symbolicValue, size_t symbolicValueSize,
    PEAK_ENUMERATION_ENTRY_NODE_HANDLE* enumerationEntryNodeHandle);

/*!
 * \brief Tells the given enumeration node to try to find an entry with the given value.
 *
 * \param[in] enumerationNodeHandle The enumeration node.
 * \param[in] value The value.
 * \param[out] enumerationEntryNodeHandle The found entry or NULL if not found.
 ...
 * \since 1.10
 */
PEAK_C_API PEAK_EnumerationNode_TryFindEntryByValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle,
    int64_t value, PEAK_ENUMERATION_ENTRY_NODE_HANDLE* enumerationEntryNodeHandle);
...
PEAK_C_API PEAK_FirmwareUpdateProgressObserver_Destruct(
 ...
 /*!
 * \brief Creates a file adapter.
 *
 * \param[in] nodeMapHandle The node map.
 * \param[in] fileName The name of the selected camera file to open.
 * \param[out] fileAdapterHandle The file adapter.
 *
 * \return PEAK_RETURN_CODE_SUCCESS Everything was fine
 * \return PEAK_RETURN_CODE_INVALID_HANDLE nodeMapHandle is invalid
 * \return PEAK_RETURN_CODE_INVALID_ARGUMENT fileName or fileAdapterHandle is a null pointer
 * \return PEAK_RETURN_CODE_NOT_AVAILABLE 'FileSelector' node, or it's entry with the specified fileName is not available
 * \return PEAK_RETURN_CODE_ERROR An internal error has occurred.
 *
 * \since 1.10
 */
PEAK_C_API PEAK_FileAdapter_Construct(
    PEAK_NODE_MAP_HANDLE nodeMapHandle, const char* fileName, PEAK_FILE_ADAPTER_HANDLE* fileAdapterHandle);

 /*!
* \brief Destroys the given file adapter.
*
* \param[in] fileAdapterHandle The file adapter.
*
* \return PEAK_RETURN_CODE_SUCCESS Everything was fine
* \return PEAK_RETURN_CODE_INVALID_HANDLE fileAdapter is invalid
* \return PEAK_RETURN_CODE_ERROR An internal error has occurred.
 *
 * \since 1.10
 */
PEAK_C_API PEAK_FileAdapter_Destruct(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle);

 /*!
* \brief Reads from the given file.
*
* \param[in] fileAdapterHandle The file adapter.
* \param[in] size The amount of data to be read.
* \param[in] offset The position from the beginning of the file where data reading should start.
* \param[out] data The file content.
* \param[out] dataSize The actual amount of data read.
*
* \return PEAK_RETURN_CODE_SUCCESS Everything was fine
* \return PEAK_RETURN_CODE_INVALID_HANDLE fileAdapter is invalid
* \return PEAK_RETURN_CODE_OUT_OF_RANGE size + offset exceeds the specified file's size
* \return PEAK_RETURN_CODE_ERROR An internal error has occurred.
 *
 * \since 1.10
 */
PEAK_C_API PEAK_FileAdapter_Read(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, uint64_t size, uint64_t offset, uint8_t* data, uint64_t* dataSize);
...
* \param[in] offset Defines where to write the data.
*
* \return PEAK_RETURN_CODE_SUCCESS Everything was fine
* \return PEAK_RETURN_CODE_INVALID_HANDLE fileAdapter is invalid
* \return PEAK_RETURN_CODE_OUT_OF_RANGE size + offset exceeds the specified file's size or offset cannot be set
* \return PEAK_RETURN_CODE_ERROR An internal error has occurred.
 *
 * \since 1.10
 */
PEAK_C_API PEAK_FileAdapter_Write(
    PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, const uint8_t* data, uint64_t size, uint64_t offset);
...
* \return PEAK_RETURN_CODE_SUCCESS Everything was fine
* \return PEAK_RETURN_CODE_INVALID_HANDLE fileAdapter is invalid
* \return PEAK_RETURN_CODE_ERROR An internal error has occurred or file cannot be removed.
 *
 * \since 1.10
 */
PEAK_C_API PEAK_FileAdapter_Delete(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle);

/*!
* \brief Queries the size of the given file.
*
* \param[in] fileAdapterHandle The file adapter.
 ...
 * \since 1.10
 */
PEAK_C_API PEAK_FileAdapter_GetSize(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, uint64_t* size);


/*!
* \brief Queries the maximum size of the given file.
*
* \param[in] fileAdapterHandle The file adapter.
* \param[out] maxSize The maximum size of the file.
*
* \return PEAK_RETURN_CODE_SUCCESS Everything was fine
* \return PEAK_RETURN_CODE_INVALID_HANDLE fileAdapter is invalid
* \return PEAK_RETURN_CODE_ERROR An internal error has occurred.
 ...
 * \since 1.10
 */
PEAK_C_API PEAK_FileAdapter_GetMaxSize(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, uint64_t* maxSize);
