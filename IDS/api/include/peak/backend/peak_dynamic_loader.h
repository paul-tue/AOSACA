...
typedef PEAK_C_API (*dyn_PEAK_Library_Initialize)();
typedef PEAK_C_API (*dyn_PEAK_Library_Close)();
typedef PEAK_C_API (*dyn_PEAK_Library_IsInitialized)(PEAK_BOOL8 * isInitialized);
typedef PEAK_C_API (*dyn_PEAK_Library_GetVersionMajor)(uint32_t * libraryVersionMajor);
typedef PEAK_C_API (*dyn_PEAK_Library_GetVersionMinor)(uint32_t * libraryVersionMinor);
typedef PEAK_C_API (*dyn_PEAK_Library_GetVersionSubminor)(uint32_t * libraryVersionSubminor);
typedef PEAK_C_API (*dyn_PEAK_Library_GetLastError)(PEAK_RETURN_CODE * lastErrorCode, char * lastErrorDescription, size_t * lastErrorDescriptionSize);
typedef PEAK_C_API (*dyn_PEAK_EnvironmentInspector_UpdateCTIPaths)();
typedef PEAK_C_API (*dyn_PEAK_EnvironmentInspector_GetNumCTIPaths)(size_t * numCtiPaths);
typedef PEAK_C_API (*dyn_PEAK_EnvironmentInspector_GetCTIPath)(size_t index, char * ctiPath, size_t * ctiPathSize);
typedef PEAK_C_API (*dyn_PEAK_ProducerLibrary_Construct)(const char * ctiPath, size_t ctiPathSize, PEAK_PRODUCER_LIBRARY_HANDLE * producerLibraryHandle);
typedef PEAK_C_API (*dyn_PEAK_ProducerLibrary_GetKey)(PEAK_PRODUCER_LIBRARY_HANDLE producerLibraryHandle, char * key, size_t * keySize);
typedef PEAK_C_API (*dyn_PEAK_ProducerLibrary_GetSystem)(PEAK_PRODUCER_LIBRARY_HANDLE producerLibraryHandle, PEAK_SYSTEM_DESCRIPTOR_HANDLE * systemDescriptorHandle);
typedef PEAK_C_API (*dyn_PEAK_ProducerLibrary_Destruct)(PEAK_PRODUCER_LIBRARY_HANDLE producerLibraryHandle);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_ToModuleDescriptor)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, PEAK_MODULE_DESCRIPTOR_HANDLE * moduleDescriptorHandle);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetKey)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * key, size_t * keySize);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetInfo)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetDisplayName)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * displayName, size_t * displayNameSize);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetVendorName)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * vendorName, size_t * vendorNameSize);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetModelName)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * modelName, size_t * modelNameSize);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetVersion)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * version, size_t * versionSize);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetTLType)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * tlType, size_t * tlTypeSize);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetCTIFileName)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * ctiFileName, size_t * ctiFileNameSize);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetCTIFullPath)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * ctiFullPath, size_t * ctiFullPathSize);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetGenTLVersionMajor)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, uint32_t * gentlVersionMajor);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetGenTLVersionMinor)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, uint32_t * gentlVersionMinor);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetCharacterEncoding)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, PEAK_CHARACTER_ENCODING * characterEncoding);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_GetParentLibrary)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, PEAK_PRODUCER_LIBRARY_HANDLE * producerLibraryHandle);
typedef PEAK_C_API (*dyn_PEAK_SystemDescriptor_OpenSystem)(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, PEAK_SYSTEM_HANDLE * systemHandle);
typedef PEAK_C_API (*dyn_PEAK_System_ToModule)(PEAK_SYSTEM_HANDLE systemHandle, PEAK_MODULE_HANDLE * moduleHandle);
typedef PEAK_C_API (*dyn_PEAK_System_ToEventSupportingModule)(PEAK_SYSTEM_HANDLE systemHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle);
typedef PEAK_C_API (*dyn_PEAK_System_GetKey)(PEAK_SYSTEM_HANDLE systemHandle, char * key, size_t * keySize);
typedef PEAK_C_API (*dyn_PEAK_System_GetInfo)(PEAK_SYSTEM_HANDLE systemHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_System_GetID)(PEAK_SYSTEM_HANDLE systemHandle, char * id, size_t * idSize);
typedef PEAK_C_API (*dyn_PEAK_System_GetDisplayName)(PEAK_SYSTEM_HANDLE systemHandle, char * displayName, size_t * displayNameSize);
typedef PEAK_C_API (*dyn_PEAK_System_GetVendorName)(PEAK_SYSTEM_HANDLE systemHandle, char * vendorName, size_t * vendorNameSize);
typedef PEAK_C_API (*dyn_PEAK_System_GetModelName)(PEAK_SYSTEM_HANDLE systemHandle, char * modelName, size_t * modelNameSize);
typedef PEAK_C_API (*dyn_PEAK_System_GetVersion)(PEAK_SYSTEM_HANDLE systemHandle, char * version, size_t * versionSize);
typedef PEAK_C_API (*dyn_PEAK_System_GetTLType)(PEAK_SYSTEM_HANDLE systemHandle, char * tlType, size_t * tlTypeSize);
typedef PEAK_C_API (*dyn_PEAK_System_GetCTIFileName)(PEAK_SYSTEM_HANDLE systemHandle, char * ctiFileName, size_t * ctiFileNameSize);
typedef PEAK_C_API (*dyn_PEAK_System_GetCTIFullPath)(PEAK_SYSTEM_HANDLE systemHandle, char * ctiFullPath, size_t * ctiFullPathSize);
typedef PEAK_C_API (*dyn_PEAK_System_GetGenTLVersionMajor)(PEAK_SYSTEM_HANDLE systemHandle, uint32_t * gentlVersionMajor);
typedef PEAK_C_API (*dyn_PEAK_System_GetGenTLVersionMinor)(PEAK_SYSTEM_HANDLE systemHandle, uint32_t * gentlVersionMinor);
typedef PEAK_C_API (*dyn_PEAK_System_GetCharacterEncoding)(PEAK_SYSTEM_HANDLE systemHandle, PEAK_CHARACTER_ENCODING * characterEncoding);
typedef PEAK_C_API (*dyn_PEAK_System_GetParentLibrary)(PEAK_SYSTEM_HANDLE systemHandle, PEAK_PRODUCER_LIBRARY_HANDLE * producerLibraryHandle);
typedef PEAK_C_API (*dyn_PEAK_System_UpdateInterfaces)(PEAK_SYSTEM_HANDLE systemHandle, uint64_t timeout_ms);
typedef PEAK_C_API (*dyn_PEAK_System_GetNumInterfaces)(PEAK_SYSTEM_HANDLE systemHandle, size_t * numInterfaces);
typedef PEAK_C_API (*dyn_PEAK_System_GetInterface)(PEAK_SYSTEM_HANDLE systemHandle, size_t index, PEAK_INTERFACE_DESCRIPTOR_HANDLE * interfaceDescriptorHandle);
typedef PEAK_C_API (*dyn_PEAK_System_RegisterInterfaceFoundCallback)(PEAK_SYSTEM_HANDLE systemHandle, PEAK_INTERFACE_FOUND_CALLBACK callback, void * callbackContext, PEAK_INTERFACE_FOUND_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_System_UnregisterInterfaceFoundCallback)(PEAK_SYSTEM_HANDLE systemHandle, PEAK_INTERFACE_FOUND_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_System_RegisterInterfaceLostCallback)(PEAK_SYSTEM_HANDLE systemHandle, PEAK_INTERFACE_LOST_CALLBACK callback, void * callbackContext, PEAK_INTERFACE_LOST_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_System_UnregisterInterfaceLostCallback)(PEAK_SYSTEM_HANDLE systemHandle, PEAK_INTERFACE_LOST_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_System_Destruct)(PEAK_SYSTEM_HANDLE systemHandle);
typedef PEAK_C_API (*dyn_PEAK_InterfaceDescriptor_ToModuleDescriptor)(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, PEAK_MODULE_DESCRIPTOR_HANDLE * moduleDescriptorHandle);
typedef PEAK_C_API (*dyn_PEAK_InterfaceDescriptor_GetKey)(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, char * key, size_t * keySize);
typedef PEAK_C_API (*dyn_PEAK_InterfaceDescriptor_GetInfo)(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_InterfaceDescriptor_GetDisplayName)(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, char * displayName, size_t * displayNameSize);
typedef PEAK_C_API (*dyn_PEAK_InterfaceDescriptor_GetTLType)(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, char * tlType, size_t * tlTypeSize);
typedef PEAK_C_API (*dyn_PEAK_InterfaceDescriptor_GetParentSystem)(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, PEAK_SYSTEM_HANDLE * systemHandle);
typedef PEAK_C_API (*dyn_PEAK_InterfaceDescriptor_OpenInterface)(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, PEAK_INTERFACE_HANDLE * interfaceHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_ToModule)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_MODULE_HANDLE * moduleHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_ToEventSupportingModule)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_GetKey)(PEAK_INTERFACE_HANDLE interfaceHandle, char * key, size_t * keySize);
typedef PEAK_C_API (*dyn_PEAK_Interface_GetInfo)(PEAK_INTERFACE_HANDLE interfaceHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_Interface_GetID)(PEAK_INTERFACE_HANDLE interfaceHandle, char * id, size_t * idSize);
typedef PEAK_C_API (*dyn_PEAK_Interface_GetDisplayName)(PEAK_INTERFACE_HANDLE interfaceHandle, char * displayName, size_t * displayNameSize);
typedef PEAK_C_API (*dyn_PEAK_Interface_GetTLType)(PEAK_INTERFACE_HANDLE interfaceHandle, char * tlType, size_t * tlTypeSize);
typedef PEAK_C_API (*dyn_PEAK_Interface_GetParentSystem)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_SYSTEM_HANDLE * systemHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_UpdateDevices)(PEAK_INTERFACE_HANDLE interfaceHandle, uint64_t timeout_ms);
typedef PEAK_C_API (*dyn_PEAK_Interface_GetNumDevices)(PEAK_INTERFACE_HANDLE interfaceHandle, size_t * numDevices);
typedef PEAK_C_API (*dyn_PEAK_Interface_GetDevice)(PEAK_INTERFACE_HANDLE interfaceHandle, size_t index, PEAK_DEVICE_DESCRIPTOR_HANDLE * deviceDescriptorHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_RegisterDeviceFoundCallback)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_FOUND_CALLBACK callback, void * callbackContext, PEAK_DEVICE_FOUND_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_UnregisterDeviceFoundCallback)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_FOUND_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_RegisterDeviceReconnectedCallback)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_RECONNECTED_CALLBACK callback, void * callbackContext, PEAK_DEVICE_RECONNECTED_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_UnregisterDeviceReconnectedCallback)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_RECONNECTED_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_RegisterDeviceDisconnectedCallback)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_DISCONNETED_CALLBACK callback, void * callbackContext, PEAK_DEVICE_DISCONNECTED_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_UnregisterDeviceDisconnectedCallback)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_DISCONNECTED_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_RegisterDeviceLostCallback)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LOST_CALLBACK callback, void * callbackContext, PEAK_DEVICE_LOST_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_UnregisterDeviceLostCallback)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LOST_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_RegisterDeviceListChangedCallback)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LIST_CHANGED_CALLBACK callback, void * callbackContext, PEAK_DEVICE_LIST_CHANGED_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_UnregisterDeviceListChangedCallback)(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LIST_CHANGED_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_Interface_Destruct)(PEAK_INTERFACE_HANDLE interfaceHandle);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_ToModuleDescriptor)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_MODULE_DESCRIPTOR_HANDLE * moduleDescriptorHandle);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetKey)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * key, size_t * keySize);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetInfo)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetDisplayName)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * displayName, size_t * displayNameSize);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetVendorName)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * vendorName, size_t * vendorNameSize);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetModelName)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * modelName, size_t * modelNameSize);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetVersion)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * version, size_t * versionSize);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetTLType)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * tlType, size_t * tlTypeSize);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetUserDefinedName)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * userDefinedName, size_t * userDefinedNameSize);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetSerialNumber)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * serialNumber, size_t * serialNumberSize);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetAccessStatus)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_ACCESS_STATUS * accessStatus);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetTimestampTickFrequency)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, uint64_t * timestampTickFrequency);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetIsOpenableExclusive)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_BOOL8 * isOpenable);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetIsOpenable)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_ACCESS_TYPE accessType, PEAK_BOOL8 * isOpenable);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_OpenDevice)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_ACCESS_TYPE accessType, PEAK_DEVICE_HANDLE * deviceHandle);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetParentInterface)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_INTERFACE_HANDLE * interfaceHandle);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_GetMonitoringUpdateInterval)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, uint64_t * monitoringUpdateInterval_ms);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_SetMonitoringUpdateInterval)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, uint64_t monitoringUpdateInterval_ms);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_IsInformationRoleMonitored)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_INFORMATION_ROLE informationRole, PEAK_BOOL8 * isInformationRoleMonitored);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_AddInformationRoleToMonitoring)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_INFORMATION_ROLE informationRole);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_RemoveInformationRoleFromMonitoring)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_INFORMATION_ROLE informationRole);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_RegisterInformationChangedCallback)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_DESCRIPTOR_INFORMATION_CHANGED_CALLBACK callback, void * callbackContext, PEAK_DEVICE_DESCRIPTOR_INFORMATION_CHANGED_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_DeviceDescriptor_UnregisterInformationChangedCallback)(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_DESCRIPTOR_INFORMATION_CHANGED_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_Device_ToModule)(PEAK_DEVICE_HANDLE deviceHandle, PEAK_MODULE_HANDLE * moduleHandle);
typedef PEAK_C_API (*dyn_PEAK_Device_ToEventSupportingModule)(PEAK_DEVICE_HANDLE deviceHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle);
typedef PEAK_C_API (*dyn_PEAK_Device_GetKey)(PEAK_DEVICE_HANDLE deviceHandle, char * key, size_t * keySize);
typedef PEAK_C_API (*dyn_PEAK_Device_GetInfo)(PEAK_DEVICE_HANDLE deviceHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_Device_GetID)(PEAK_DEVICE_HANDLE deviceHandle, char * id, size_t * idSize);
typedef PEAK_C_API (*dyn_PEAK_Device_GetDisplayName)(PEAK_DEVICE_HANDLE deviceHandle, char * displayName, size_t * displayNameSize);
typedef PEAK_C_API (*dyn_PEAK_Device_GetVendorName)(PEAK_DEVICE_HANDLE deviceHandle, char * vendorName, size_t * vendorNameSize);
typedef PEAK_C_API (*dyn_PEAK_Device_GetModelName)(PEAK_DEVICE_HANDLE deviceHandle, char * modelName, size_t * modelNameSize);
typedef PEAK_C_API (*dyn_PEAK_Device_GetVersion)(PEAK_DEVICE_HANDLE deviceHandle, char * version, size_t * versionSize);
typedef PEAK_C_API (*dyn_PEAK_Device_GetTLType)(PEAK_DEVICE_HANDLE deviceHandle, char * tlType, size_t * tlTypeSize);
typedef PEAK_C_API (*dyn_PEAK_Device_GetUserDefinedName)(PEAK_DEVICE_HANDLE deviceHandle, char * userDefinedName, size_t * userDefinedNameSize);
typedef PEAK_C_API (*dyn_PEAK_Device_GetSerialNumber)(PEAK_DEVICE_HANDLE deviceHandle, char * serialNumber, size_t * serialNumberSize);
typedef PEAK_C_API (*dyn_PEAK_Device_GetAccessStatus)(PEAK_DEVICE_HANDLE deviceHandle, PEAK_DEVICE_ACCESS_STATUS * accessStatus);
typedef PEAK_C_API (*dyn_PEAK_Device_GetTimestampTickFrequency)(PEAK_DEVICE_HANDLE deviceHandle, uint64_t * timestampTickFrequency);
typedef PEAK_C_API (*dyn_PEAK_Device_GetParentInterface)(PEAK_DEVICE_HANDLE deviceHandle, PEAK_INTERFACE_HANDLE * interfaceHandle);
typedef PEAK_C_API (*dyn_PEAK_Device_GetRemoteDevice)(PEAK_DEVICE_HANDLE deviceHandle, PEAK_REMOTE_DEVICE_HANDLE * remoteDeviceHandle);
typedef PEAK_C_API (*dyn_PEAK_Device_GetNumDataStreams)(PEAK_DEVICE_HANDLE deviceHandle, size_t * numDataStreams);
typedef PEAK_C_API (*dyn_PEAK_Device_GetDataStream)(PEAK_DEVICE_HANDLE deviceHandle, size_t index, PEAK_DATA_STREAM_DESCRIPTOR_HANDLE * dataStreamDescriptorHandle);
typedef PEAK_C_API (*dyn_PEAK_Device_Destruct)(PEAK_DEVICE_HANDLE deviceHandle);
typedef PEAK_C_API (*dyn_PEAK_RemoteDevice_ToModule)(PEAK_REMOTE_DEVICE_HANDLE remoteDeviceHandle, PEAK_MODULE_HANDLE * moduleHandle);
typedef PEAK_C_API (*dyn_PEAK_RemoteDevice_GetLocalDevice)(PEAK_REMOTE_DEVICE_HANDLE remoteDeviceHandle, PEAK_DEVICE_HANDLE * deviceHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStreamDescriptor_ToModuleDescriptor)(PEAK_DATA_STREAM_DESCRIPTOR_HANDLE dataStreamDescriptorHandle, PEAK_MODULE_DESCRIPTOR_HANDLE * moduleDescriptorHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStreamDescriptor_GetKey)(PEAK_DATA_STREAM_DESCRIPTOR_HANDLE dataStreamDescriptorHandle, char * key, size_t * keySize);
typedef PEAK_C_API (*dyn_PEAK_DataStreamDescriptor_GetParentDevice)(PEAK_DATA_STREAM_DESCRIPTOR_HANDLE dataStreamDescriptorHandle, PEAK_DEVICE_HANDLE * deviceHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStreamDescriptor_OpenDataStream)(PEAK_DATA_STREAM_DESCRIPTOR_HANDLE dataStreamDescriptorHandle, PEAK_DATA_STREAM_HANDLE * dataStreamHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStream_ToModule)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_MODULE_HANDLE * moduleHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStream_ToEventSupportingModule)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetKey)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, char * key, size_t * keySize);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetInfo)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetID)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, char * id, size_t * idSize);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetTLType)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, char * tlType, size_t * tlTypeSize);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetNumBuffersAnnouncedMinRequired)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numBuffersAnnouncedMinRequired);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetNumBuffersAnnounced)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numBuffersAnnounced);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetNumBuffersQueued)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numBuffersQueued);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetNumBuffersAwaitDelivery)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numBuffersAwaitDelivery);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetNumBuffersDelivered)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, uint64_t * numBuffersDelivered);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetNumBuffersStarted)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, uint64_t * numBuffersStarted);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetNumUnderruns)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, uint64_t * numUnderruns);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetNumChunksPerBufferMax)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numChunksPerBufferMax);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetBufferAlignment)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * bufferAlignment);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetPayloadSize)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * payloadSize);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetDefinesPayloadSize)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_BOOL8 * definesPayloadSize);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetIsGrabbing)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_BOOL8 * isGrabbing);
typedef PEAK_C_API (*dyn_PEAK_DataStream_GetParentDevice)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_DEVICE_HANDLE * deviceHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStream_AnnounceBuffer)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, void * buffer, size_t bufferSize, void * userPtr, PEAK_BUFFER_REVOCATION_CALLBACK revocationCallback, void * callbackContext, PEAK_BUFFER_HANDLE * bufferHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStream_AllocAndAnnounceBuffer)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t bufferSize, void * userPtr, PEAK_BUFFER_HANDLE * bufferHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStream_QueueBuffer)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_BUFFER_HANDLE bufferHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStream_RevokeBuffer)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_BUFFER_HANDLE bufferHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStream_WaitForFinishedBuffer)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, uint64_t timeout_ms, PEAK_BUFFER_HANDLE * bufferHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStream_KillWait)(PEAK_DATA_STREAM_HANDLE dataStreamHandle);
typedef PEAK_C_API (*dyn_PEAK_DataStream_Flush)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_DATA_STREAM_FLUSH_MODE flushMode);
typedef PEAK_C_API (*dyn_PEAK_DataStream_StartAcquisitionInfinite)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_ACQUISITION_START_MODE startMode);
typedef PEAK_C_API (*dyn_PEAK_DataStream_StartAcquisition)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_ACQUISITION_START_MODE startMode, uint64_t numToAcquire);
typedef PEAK_C_API (*dyn_PEAK_DataStream_StopAcquisition)(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_ACQUISITION_STOP_MODE stopMode);
typedef PEAK_C_API (*dyn_PEAK_DataStream_Destruct)(PEAK_DATA_STREAM_HANDLE dataStreamHandle);
typedef PEAK_C_API (*dyn_PEAK_Buffer_ToModule)(PEAK_BUFFER_HANDLE bufferHandle, PEAK_MODULE_HANDLE * moduleHandle);
typedef PEAK_C_API (*dyn_PEAK_Buffer_ToEventSupportingModule)(PEAK_BUFFER_HANDLE bufferHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetInfo)(PEAK_BUFFER_HANDLE bufferHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetTLType)(PEAK_BUFFER_HANDLE bufferHandle, char * tlType, size_t * tlTypeSize);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetBasePtr)(PEAK_BUFFER_HANDLE bufferHandle, void * * basePtr);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetSize)(PEAK_BUFFER_HANDLE bufferHandle, size_t * size);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetUserPtr)(PEAK_BUFFER_HANDLE bufferHandle, void * * userPtr);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetPayloadType)(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BUFFER_PAYLOAD_TYPE * payloadType);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetPixelFormat)(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * pixelFormat);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetPixelFormatNamespace)(PEAK_BUFFER_HANDLE bufferHandle, PEAK_PIXEL_FORMAT_NAMESPACE * pixelFormatNamespace);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetPixelEndianness)(PEAK_BUFFER_HANDLE bufferHandle, PEAK_ENDIANNESS * pixelEndianness);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetExpectedDataSize)(PEAK_BUFFER_HANDLE bufferHandle, size_t * expectedDataSize);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetDeliveredDataSize)(PEAK_BUFFER_HANDLE bufferHandle, size_t * deliveredDataSize);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetFrameID)(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * frameId);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetImageOffset)(PEAK_BUFFER_HANDLE bufferHandle, size_t * imageOffset);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetDeliveredImageHeight)(PEAK_BUFFER_HANDLE bufferHandle, size_t * deliveredImageHeight);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetDeliveredChunkPayloadSize)(PEAK_BUFFER_HANDLE bufferHandle, size_t * deliveredChunkPayloadSize);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetChunkLayoutID)(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * chunkLayoutId);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetFileName)(PEAK_BUFFER_HANDLE bufferHandle, char * fileName, size_t * fileNameSize);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetWidth)(PEAK_BUFFER_HANDLE bufferHandle, size_t * width);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetHeight)(PEAK_BUFFER_HANDLE bufferHandle, size_t * height);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetXOffset)(PEAK_BUFFER_HANDLE bufferHandle, size_t * xOffset);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetYOffset)(PEAK_BUFFER_HANDLE bufferHandle, size_t * yOffset);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetXPadding)(PEAK_BUFFER_HANDLE bufferHandle, size_t * xPadding);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetYPadding)(PEAK_BUFFER_HANDLE bufferHandle, size_t * yPadding);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetTimestamp_ticks)(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * timestamp_ticks);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetTimestamp_ns)(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * timestamp_ns);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetIsQueued)(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * isQueued);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetIsAcquiring)(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * isAcquiring);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetIsIncomplete)(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * isIncomplete);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetHasNewData)(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasNewData);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetHasImage)(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasImage);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetHasChunks)(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasChunks);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetHasParts)(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasParts);
typedef PEAK_C_API (*dyn_PEAK_Buffer_UpdateChunks)(PEAK_BUFFER_HANDLE bufferHandle);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetNumChunks)(PEAK_BUFFER_HANDLE bufferHandle, size_t * numChunks);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetChunk)(PEAK_BUFFER_HANDLE bufferHandle, size_t index, PEAK_BUFFER_CHUNK_HANDLE * bufferChunkHandle);
typedef PEAK_C_API (*dyn_PEAK_Buffer_UpdateParts)(PEAK_BUFFER_HANDLE bufferHandle);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetNumParts)(PEAK_BUFFER_HANDLE bufferHandle, size_t * numParts);
typedef PEAK_C_API (*dyn_PEAK_Buffer_GetPart)(PEAK_BUFFER_HANDLE bufferHandle, size_t index, PEAK_BUFFER_PART_HANDLE * bufferPartHandle);
typedef PEAK_C_API (*dyn_PEAK_BufferChunk_GetID)(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle, uint64_t * id);
typedef PEAK_C_API (*dyn_PEAK_BufferChunk_GetBasePtr)(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle, void * * basePtr);
typedef PEAK_C_API (*dyn_PEAK_BufferChunk_GetSize)(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle, size_t * size);
typedef PEAK_C_API (*dyn_PEAK_BufferChunk_GetParentBuffer)(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle, PEAK_BUFFER_HANDLE * bufferHandle);
typedef PEAK_C_API (*dyn_PEAK_BufferChunk_Destruct)(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetInfo)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetSourceID)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, uint64_t * sourceId);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetBasePtr)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, void * * basePtr);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetSize)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * size);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetType)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, PEAK_BUFFER_PART_TYPE * type);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetFormat)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, uint64_t * format);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetFormatNamespace)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, uint64_t * formatNamespace);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetWidth)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * width);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetHeight)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * height);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetXOffset)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * xOffset);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetYOffset)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * yOffset);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetXPadding)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * xPadding);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetDeliveredImageHeight)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * deliveredImageHeight);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_GetParentBuffer)(PEAK_BUFFER_PART_HANDLE bufferPartHandle, PEAK_BUFFER_HANDLE * bufferHandle);
typedef PEAK_C_API (*dyn_PEAK_BufferPart_Destruct)(PEAK_BUFFER_PART_HANDLE bufferPartHandle);
typedef PEAK_C_API (*dyn_PEAK_ModuleDescriptor_GetID)(PEAK_MODULE_DESCRIPTOR_HANDLE moduleDescriptorHandle, char * id, size_t * idSize);
typedef PEAK_C_API (*dyn_PEAK_Module_GetNumNodeMaps)(PEAK_MODULE_HANDLE moduleHandle, size_t * numNodeMaps);
typedef PEAK_C_API (*dyn_PEAK_Module_GetNodeMap)(PEAK_MODULE_HANDLE moduleHandle, size_t index, PEAK_NODE_MAP_HANDLE * nodeMapHandle);
typedef PEAK_C_API (*dyn_PEAK_Module_GetPort)(PEAK_MODULE_HANDLE moduleHandle, PEAK_PORT_HANDLE * portHandle);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_GetHasNode)(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * nodeName, size_t nodeNameSize, PEAK_BOOL8 * hasNode);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_FindNode)(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * nodeName, size_t nodeNameSize, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_TryFindNode)(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * nodeName, size_t nodeNameSize, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_InvalidateNodes)(PEAK_NODE_MAP_HANDLE nodeMapHandle);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_PollNodes)(PEAK_NODE_MAP_HANDLE nodeMapHandle, int64_t elapsedTime_ms);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_GetNumNodes)(PEAK_NODE_MAP_HANDLE nodeMapHandle, size_t * numNodes);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_GetNode)(PEAK_NODE_MAP_HANDLE nodeMapHandle, size_t index, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_GetHasBufferSupportedChunks)(PEAK_NODE_MAP_HANDLE nodeMapHandle, PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasSupportedChunks);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_UpdateChunkNodes)(PEAK_NODE_MAP_HANDLE nodeMapHandle, PEAK_BUFFER_HANDLE bufferHandle);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_GetHasEventSupportedData)(PEAK_NODE_MAP_HANDLE nodeMapHandle, PEAK_EVENT_HANDLE eventHandle, PEAK_BOOL8 * hasSupportedData);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_UpdateEventNodes)(PEAK_NODE_MAP_HANDLE nodeMapHandle, PEAK_EVENT_HANDLE eventHandle);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_StoreToFile)(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * filePath, size_t filePathSize);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_LoadFromFile)(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * filePath, size_t filePathSize);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_Lock)(PEAK_NODE_MAP_HANDLE nodeMapHandle);
typedef PEAK_C_API (*dyn_PEAK_NodeMap_Unlock)(PEAK_NODE_MAP_HANDLE nodeMapHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_ToIntegerNode)(PEAK_NODE_HANDLE nodeHandle, PEAK_INTEGER_NODE_HANDLE * integerNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_ToBooleanNode)(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOLEAN_NODE_HANDLE * booleanNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_ToCommandNode)(PEAK_NODE_HANDLE nodeHandle, PEAK_COMMAND_NODE_HANDLE * commandNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_ToFloatNode)(PEAK_NODE_HANDLE nodeHandle, PEAK_FLOAT_NODE_HANDLE * floatNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_ToStringNode)(PEAK_NODE_HANDLE nodeHandle, PEAK_STRING_NODE_HANDLE * stringNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_ToRegisterNode)(PEAK_NODE_HANDLE nodeHandle, PEAK_REGISTER_NODE_HANDLE * registerNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_ToCategoryNode)(PEAK_NODE_HANDLE nodeHandle, PEAK_CATEGORY_NODE_HANDLE * categoryNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_ToEnumerationNode)(PEAK_NODE_HANDLE nodeHandle, PEAK_ENUMERATION_NODE_HANDLE * enumerationNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_ToEnumerationEntryNode)(PEAK_NODE_HANDLE nodeHandle, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_GetName)(PEAK_NODE_HANDLE nodeHandle, char * name, size_t * nameSize);
typedef PEAK_C_API (*dyn_PEAK_Node_GetDisplayName)(PEAK_NODE_HANDLE nodeHandle, char * displayName, size_t * displayNameSize);
typedef PEAK_C_API (*dyn_PEAK_Node_GetNamespace)(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_NAMESPACE * _namespace);
typedef PEAK_C_API (*dyn_PEAK_Node_GetVisibility)(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_VISIBILITY * visibility);
typedef PEAK_C_API (*dyn_PEAK_Node_GetAccessStatus)(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_ACCESS_STATUS * accessStatus);
typedef PEAK_C_API (*dyn_PEAK_Node_GetIsCacheable)(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isCacheable);
typedef PEAK_C_API (*dyn_PEAK_Node_GetIsAccessStatusCacheable)(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isAccessStatusCacheable);
typedef PEAK_C_API (*dyn_PEAK_Node_GetIsStreamable)(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isStreamable);
typedef PEAK_C_API (*dyn_PEAK_Node_GetIsDeprecated)(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isDeprecated);
typedef PEAK_C_API (*dyn_PEAK_Node_GetIsFeature)(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isFeature);
typedef PEAK_C_API (*dyn_PEAK_Node_GetCachingMode)(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_CACHING_MODE * cachingMode);
typedef PEAK_C_API (*dyn_PEAK_Node_GetPollingTime)(PEAK_NODE_HANDLE nodeHandle, int64_t * pollingTime_ms);
typedef PEAK_C_API (*dyn_PEAK_Node_GetToolTip)(PEAK_NODE_HANDLE nodeHandle, char * toolTip, size_t * toolTipSize);
typedef PEAK_C_API (*dyn_PEAK_Node_GetDescription)(PEAK_NODE_HANDLE nodeHandle, char * description, size_t * descriptionSize);
typedef PEAK_C_API (*dyn_PEAK_Node_GetType)(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_TYPE * type);
typedef PEAK_C_API (*dyn_PEAK_Node_GetParentNodeMap)(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_MAP_HANDLE * nodeMapHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_FindInvalidatedNode)(PEAK_NODE_HANDLE nodeHandle, const char * name, size_t nameSize, PEAK_NODE_HANDLE * invalidatedNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_GetNumInvalidatedNodes)(PEAK_NODE_HANDLE nodeHandle, size_t * numInvalidatedNodes);
typedef PEAK_C_API (*dyn_PEAK_Node_GetInvalidatedNode)(PEAK_NODE_HANDLE nodeHandle, size_t index, PEAK_NODE_HANDLE * invalidatedNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_FindInvalidatingNode)(PEAK_NODE_HANDLE nodeHandle, const char * name, size_t nameSize, PEAK_NODE_HANDLE * invalidatingNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_GetNumInvalidatingNodes)(PEAK_NODE_HANDLE nodeHandle, size_t * numInvalidatingNodes);
typedef PEAK_C_API (*dyn_PEAK_Node_GetInvalidatingNode)(PEAK_NODE_HANDLE nodeHandle, size_t index, PEAK_NODE_HANDLE * invalidatingNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_FindSelectedNode)(PEAK_NODE_HANDLE nodeHandle, const char * name, size_t nameSize, PEAK_NODE_HANDLE * selectedNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_GetNumSelectedNodes)(PEAK_NODE_HANDLE nodeHandle, size_t * numSelectedNodes);
typedef PEAK_C_API (*dyn_PEAK_Node_GetSelectedNode)(PEAK_NODE_HANDLE nodeHandle, size_t index, PEAK_NODE_HANDLE * selectedNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_FindSelectingNode)(PEAK_NODE_HANDLE nodeHandle, const char * name, size_t nameSize, PEAK_NODE_HANDLE * selectingNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_GetNumSelectingNodes)(PEAK_NODE_HANDLE nodeHandle, size_t * numSelectingNodes);
typedef PEAK_C_API (*dyn_PEAK_Node_GetSelectingNode)(PEAK_NODE_HANDLE nodeHandle, size_t index, PEAK_NODE_HANDLE * selectingNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_RegisterChangedCallback)(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_CHANGED_CALLBACK callback, void * callbackContext, PEAK_NODE_CHANGED_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_Node_UnregisterChangedCallback)(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_CHANGED_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_IntegerNode_ToNode)(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_IntegerNode_GetMinimum)(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t * minimum);
typedef PEAK_C_API (*dyn_PEAK_IntegerNode_GetMaximum)(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t * maximum);
typedef PEAK_C_API (*dyn_PEAK_IntegerNode_GetIncrement)(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t * increment);
typedef PEAK_C_API (*dyn_PEAK_IntegerNode_GetIncrementType)(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, PEAK_NODE_INCREMENT_TYPE * incrementType);
typedef PEAK_C_API (*dyn_PEAK_IntegerNode_GetValidValues)(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t * validValues, size_t * validValuesSize);
typedef PEAK_C_API (*dyn_PEAK_IntegerNode_GetRepresentation)(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, PEAK_NODE_REPRESENTATION * representation);
typedef PEAK_C_API (*dyn_PEAK_IntegerNode_GetUnit)(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, char * unit, size_t * unitSize);
typedef PEAK_C_API (*dyn_PEAK_IntegerNode_GetValue)(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, int64_t * value);
typedef PEAK_C_API (*dyn_PEAK_IntegerNode_SetValue)(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t value);
typedef PEAK_C_API (*dyn_PEAK_BooleanNode_ToNode)(PEAK_BOOLEAN_NODE_HANDLE booleanNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_BooleanNode_GetValue)(PEAK_BOOLEAN_NODE_HANDLE booleanNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, PEAK_BOOL8 * value);
typedef PEAK_C_API (*dyn_PEAK_BooleanNode_SetValue)(PEAK_BOOLEAN_NODE_HANDLE booleanNodeHandle, PEAK_BOOL8 value);
typedef PEAK_C_API (*dyn_PEAK_CommandNode_ToNode)(PEAK_COMMAND_NODE_HANDLE commandNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_CommandNode_GetIsDone)(PEAK_COMMAND_NODE_HANDLE commandNodeHandle, PEAK_BOOL8 * isDone);
typedef PEAK_C_API (*dyn_PEAK_CommandNode_Execute)(PEAK_COMMAND_NODE_HANDLE commandNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_CommandNode_WaitUntilDoneInfinite)(PEAK_COMMAND_NODE_HANDLE commandNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_CommandNode_WaitUntilDone)(PEAK_COMMAND_NODE_HANDLE commandNodeHandle, uint64_t waitTimeout_ms);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_ToNode)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_GetMinimum)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double * minimum);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_GetMaximum)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double * maximum);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_GetIncrement)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double * increment);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_GetIncrementType)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_INCREMENT_TYPE * incrementType);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_GetValidValues)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double * validValues, size_t * validValuesSize);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_GetRepresentation)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_REPRESENTATION * representation);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_GetUnit)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, char * unit, size_t * unitSize);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_GetDisplayNotation)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_DISPLAY_NOTATION * displayNotation);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_GetDisplayPrecision)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, int64_t * displayPrecision);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_GetHasConstantIncrement)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_BOOL8 * hasConstantIncrement);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_GetValue)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, double * value);
typedef PEAK_C_API (*dyn_PEAK_FloatNode_SetValue)(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double value);
typedef PEAK_C_API (*dyn_PEAK_StringNode_ToNode)(PEAK_STRING_NODE_HANDLE stringNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_StringNode_GetMaximumLength)(PEAK_STRING_NODE_HANDLE stringNodeHandle, int64_t * maximumLength);
typedef PEAK_C_API (*dyn_PEAK_StringNode_GetValue)(PEAK_STRING_NODE_HANDLE stringNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, char * value, size_t * valueSize);
typedef PEAK_C_API (*dyn_PEAK_StringNode_SetValue)(PEAK_STRING_NODE_HANDLE stringNodeHandle, const char * value, size_t valueSize);
typedef PEAK_C_API (*dyn_PEAK_RegisterNode_ToNode)(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_RegisterNode_GetAddress)(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, uint64_t * address);
typedef PEAK_C_API (*dyn_PEAK_RegisterNode_GetLength)(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, size_t * length);
typedef PEAK_C_API (*dyn_PEAK_RegisterNode_Read)(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, uint8_t * bytesToRead, size_t bytesToReadSize);
typedef PEAK_C_API (*dyn_PEAK_RegisterNode_Write)(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, const uint8_t * bytesToWrite, size_t bytesToWriteSize);
typedef PEAK_C_API (*dyn_PEAK_CategoryNode_ToNode)(PEAK_CATEGORY_NODE_HANDLE categoryNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_CategoryNode_GetNumSubNodes)(PEAK_CATEGORY_NODE_HANDLE categoryNodeHandle, size_t * numSubNodes);
typedef PEAK_C_API (*dyn_PEAK_CategoryNode_GetSubNode)(PEAK_CATEGORY_NODE_HANDLE categoryNodeHandle, size_t index, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_ToNode)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_GetCurrentEntry)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_SetCurrentEntry)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_SetCurrentEntryBySymbolicValue)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, const char * symbolicValue, size_t symbolicValueSize);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_SetCurrentEntryByValue)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, int64_t value);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_GetHasEntryBySymbolicValue)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, const char * symbolicValue, size_t symbolicValueSize, PEAK_BOOL8 * hasEntry);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_GetHasEntryByValue)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, int64_t value, PEAK_BOOL8 * hasEntry);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_FindEntryBySymbolicValue)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, const char * symbolicValue, size_t symbolicValueSize, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_FindEntryByValue)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, int64_t value, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_TryFindEntryBySymbolicValue)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, const char * symbolicValue, size_t symbolicValueSize, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_TryFindEntryByValue)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, int64_t value, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_GetNumEntries)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, size_t * numEntries);
typedef PEAK_C_API (*dyn_PEAK_EnumerationNode_GetEntry)(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, size_t index, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
typedef PEAK_C_API (*dyn_PEAK_EnumerationEntryNode_ToNode)(PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
typedef PEAK_C_API (*dyn_PEAK_EnumerationEntryNode_GetIsSelfClearing)(PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle, PEAK_BOOL8 * isSelfClearing);
typedef PEAK_C_API (*dyn_PEAK_EnumerationEntryNode_GetSymbolicValue)(PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle, char * symbolicValue, size_t * symbolicValueSize);
typedef PEAK_C_API (*dyn_PEAK_EnumerationEntryNode_GetValue)(PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle, int64_t * value);
typedef PEAK_C_API (*dyn_PEAK_Port_GetInfo)(PEAK_PORT_HANDLE portHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_Port_GetID)(PEAK_PORT_HANDLE portHandle, char * id, size_t * idSize);
typedef PEAK_C_API (*dyn_PEAK_Port_GetName)(PEAK_PORT_HANDLE portHandle, char * name, size_t * nameSize);
typedef PEAK_C_API (*dyn_PEAK_Port_GetVendorName)(PEAK_PORT_HANDLE portHandle, char * vendorName, size_t * vendorNameSize);
typedef PEAK_C_API (*dyn_PEAK_Port_GetModelName)(PEAK_PORT_HANDLE portHandle, char * modelName, size_t * modelNameSize);
typedef PEAK_C_API (*dyn_PEAK_Port_GetVersion)(PEAK_PORT_HANDLE portHandle, char * version, size_t * versionSize);
typedef PEAK_C_API (*dyn_PEAK_Port_GetTLType)(PEAK_PORT_HANDLE portHandle, char * tlType, size_t * tlTypeSize);
typedef PEAK_C_API (*dyn_PEAK_Port_GetModuleName)(PEAK_PORT_HANDLE portHandle, char * moduleName, size_t * moduleNameSize);
typedef PEAK_C_API (*dyn_PEAK_Port_GetDataEndianness)(PEAK_PORT_HANDLE portHandle, PEAK_ENDIANNESS * dataEndianness);
typedef PEAK_C_API (*dyn_PEAK_Port_GetIsReadable)(PEAK_PORT_HANDLE portHandle, PEAK_BOOL8 * isReadable);
typedef PEAK_C_API (*dyn_PEAK_Port_GetIsWritable)(PEAK_PORT_HANDLE portHandle, PEAK_BOOL8 * isWritable);
typedef PEAK_C_API (*dyn_PEAK_Port_GetIsAvailable)(PEAK_PORT_HANDLE portHandle, PEAK_BOOL8 * isAvailable);
typedef PEAK_C_API (*dyn_PEAK_Port_GetIsImplemented)(PEAK_PORT_HANDLE portHandle, PEAK_BOOL8 * isImplemented);
typedef PEAK_C_API (*dyn_PEAK_Port_Read)(PEAK_PORT_HANDLE portHandle, uint64_t address, uint8_t * bytesToRead, size_t bytesToReadSize);
typedef PEAK_C_API (*dyn_PEAK_Port_Write)(PEAK_PORT_HANDLE portHandle, uint64_t address, const uint8_t * bytesToWrite, size_t bytesToWriteSize);
typedef PEAK_C_API (*dyn_PEAK_Port_GetNumURLs)(PEAK_PORT_HANDLE portHandle, size_t * numUrls);
typedef PEAK_C_API (*dyn_PEAK_Port_GetURL)(PEAK_PORT_HANDLE portHandle, size_t index, PEAK_PORT_URL_HANDLE * portUrlHandle);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetInfo)(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetURL)(PEAK_PORT_URL_HANDLE portUrlHandle, char * url, size_t * urlSize);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetScheme)(PEAK_PORT_URL_HANDLE portUrlHandle, PEAK_PORT_URL_SCHEME * scheme);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetFileName)(PEAK_PORT_URL_HANDLE portUrlHandle, char * fileName, size_t * fileNameSize);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetFileRegisterAddress)(PEAK_PORT_URL_HANDLE portUrlHandle, uint64_t * fileRegisterAddress);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetFileSize)(PEAK_PORT_URL_HANDLE portUrlHandle, uint64_t * fileSize);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetFileSHA1Hash)(PEAK_PORT_URL_HANDLE portUrlHandle, uint8_t * fileSha1Hash, size_t * fileSha1HashSize);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetFileVersionMajor)(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileVersionMajor);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetFileVersionMinor)(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileVersionMinor);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetFileVersionSubminor)(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileVersionSubminor);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetFileSchemaVersionMajor)(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileSchemaVersionMajor);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetFileSchemaVersionMinor)(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileSchemaVersionMinor);
typedef PEAK_C_API (*dyn_PEAK_PortURL_GetParentPort)(PEAK_PORT_URL_HANDLE portUrlHandle, PEAK_PORT_HANDLE * portHandle);
typedef PEAK_C_API (*dyn_PEAK_EventSupportingModule_EnableEvents)(PEAK_EVENT_SUPPORTING_MODULE_HANDLE eventSupportingModuleHandle, PEAK_EVENT_TYPE eventType, PEAK_EVENT_CONTROLLER_HANDLE * eventControllerHandle);
typedef PEAK_C_API (*dyn_PEAK_EventController_GetInfo)(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_EventController_GetNumEventsInQueue)(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, size_t * numEventsInQueue);
typedef PEAK_C_API (*dyn_PEAK_EventController_GetNumEventsFired)(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, uint64_t * numEventsFired);
typedef PEAK_C_API (*dyn_PEAK_EventController_GetEventMaxSize)(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, size_t * eventMaxSize);
typedef PEAK_C_API (*dyn_PEAK_EventController_GetEventDataMaxSize)(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, size_t * eventDataMaxSize);
typedef PEAK_C_API (*dyn_PEAK_EventController_GetControlledEventType)(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, PEAK_EVENT_TYPE * controlledEventType);
typedef PEAK_C_API (*dyn_PEAK_EventController_WaitForEvent)(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, uint64_t timeout_ms, PEAK_EVENT_HANDLE * eventHandle);
typedef PEAK_C_API (*dyn_PEAK_EventController_KillWait)(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle);
typedef PEAK_C_API (*dyn_PEAK_EventController_FlushEvents)(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle);
typedef PEAK_C_API (*dyn_PEAK_EventController_Destruct)(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle);
typedef PEAK_C_API (*dyn_PEAK_Event_GetInfo)(PEAK_EVENT_HANDLE eventHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
typedef PEAK_C_API (*dyn_PEAK_Event_GetID)(PEAK_EVENT_HANDLE eventHandle, uint64_t * id);
typedef PEAK_C_API (*dyn_PEAK_Event_GetData)(PEAK_EVENT_HANDLE eventHandle, uint8_t * data, size_t * dataSize);
typedef PEAK_C_API (*dyn_PEAK_Event_GetType)(PEAK_EVENT_HANDLE eventHandle, PEAK_EVENT_TYPE * type);
typedef PEAK_C_API (*dyn_PEAK_Event_GetRawData)(PEAK_EVENT_HANDLE eventHandle, uint8_t * rawData, size_t * rawDataSize);
typedef PEAK_C_API (*dyn_PEAK_Event_Destruct)(PEAK_EVENT_HANDLE eventHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdater_Construct)(PEAK_FIRMWARE_UPDATER_HANDLE * firmwareUpdaterHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdater_CollectAllFirmwareUpdateInformation)(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, const char * gufPath, size_t gufPathSize);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdater_CollectFirmwareUpdateInformation)(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, const char * gufPath, size_t gufPathSize, PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdater_GetNumFirmwareUpdateInformation)(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, size_t * numFirmwareUpdateInformation);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdater_GetFirmwareUpdateInformation)(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, size_t index, PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE * firmwareUpdateInformationHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdater_UpdateDevice)(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdater_UpdateDeviceWithResetTimeout)(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, uint64_t deviceResetDiscoveryTimeout_ms);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdater_Destruct)(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateInformation_GetIsValid)(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_BOOL8 * isValid);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateInformation_GetFileName)(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * fileName, size_t * fileNameSize);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateInformation_GetDescription)(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * description, size_t * descriptionSize);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateInformation_GetVersion)(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * version, size_t * versionSize);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateInformation_GetVersionExtractionPattern)(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * versionExtractionPattern, size_t * versionExtractionPatternSize);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateInformation_GetVersionStyle)(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_VERSION_STYLE * versionStyle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateInformation_GetReleaseNotes)(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * releaseNotes, size_t * releaseNotesSize);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateInformation_GetReleaseNotesURL)(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * releaseNotesUrl, size_t * releaseNotesUrlSize);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateInformation_GetUserSetPersistence)(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_PERSISTENCE * userSetPersistence);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateInformation_GetSequencerSetPersistence)(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_PERSISTENCE * sequencerSetPersistence);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_Construct)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE * firmwareUpdateProgressObserverHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_RegisterUpdateStartedCallback)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STARTED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_STARTED_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateStartedCallback)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STARTED_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_RegisterUpdateStepStartedCallback)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_STARTED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_STEP_STARTED_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateStepStartedCallback)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_STARTED_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_RegisterUpdateStepProgressChangedCallback)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_PROGRESS_CHANGED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_STEP_PROGRESS_CHANGED_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateStepProgressChangedCallback)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_PROGRESS_CHANGED_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_RegisterUpdateStepFinishedCallback)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_FINISHED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_STEP_FINISHED_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateStepFinishedCallback)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_FINISHED_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_RegisterUpdateFinishedCallback)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_FINISHED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_FINISHED_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateFinishedCallback)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_FINISHED_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_RegisterUpdateFailedCallback)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_FAILED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_FAILED_CALLBACK_HANDLE * callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateFailedCallback)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_FAILED_CALLBACK_HANDLE callbackHandle);
typedef PEAK_C_API (*dyn_PEAK_FirmwareUpdateProgressObserver_Destruct)(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle);
typedef PEAK_C_API (*dyn_PEAK_FileAdapter_Construct)(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * fileName, PEAK_FILE_ADAPTER_HANDLE * fileAdapterHandle);
typedef PEAK_C_API (*dyn_PEAK_FileAdapter_Destruct)(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle);
typedef PEAK_C_API (*dyn_PEAK_FileAdapter_Read)(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, uint64_t size, uint64_t offset, uint8_t * data, uint64_t * dataSize);
typedef PEAK_C_API (*dyn_PEAK_FileAdapter_Write)(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, const uint8_t * data, uint64_t size, uint64_t offset);
typedef PEAK_C_API (*dyn_PEAK_FileAdapter_Delete)(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle);
typedef PEAK_C_API (*dyn_PEAK_FileAdapter_GetSize)(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, uint64_t * size);
typedef PEAK_C_API (*dyn_PEAK_FileAdapter_GetMaxSize)(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, uint64_t * maxSize);
...
public:
    ...
    static PEAK_C_API PEAK_Library_Initialize();
    static PEAK_C_API PEAK_Library_Close();
    static PEAK_C_API PEAK_Library_IsInitialized(PEAK_BOOL8 * isInitialized);
    static PEAK_C_API PEAK_Library_GetVersionMajor(uint32_t * libraryVersionMajor);
    static PEAK_C_API PEAK_Library_GetVersionMinor(uint32_t * libraryVersionMinor);
    static PEAK_C_API PEAK_Library_GetVersionSubminor(uint32_t * libraryVersionSubminor);
    static PEAK_C_API PEAK_Library_GetLastError(PEAK_RETURN_CODE * lastErrorCode, char * lastErrorDescription, size_t * lastErrorDescriptionSize);
    static PEAK_C_API PEAK_EnvironmentInspector_UpdateCTIPaths();
    static PEAK_C_API PEAK_EnvironmentInspector_GetNumCTIPaths(size_t * numCtiPaths);
    static PEAK_C_API PEAK_EnvironmentInspector_GetCTIPath(size_t index, char * ctiPath, size_t * ctiPathSize);
    static PEAK_C_API PEAK_ProducerLibrary_Construct(const char * ctiPath, size_t ctiPathSize, PEAK_PRODUCER_LIBRARY_HANDLE * producerLibraryHandle);
    static PEAK_C_API PEAK_ProducerLibrary_GetKey(PEAK_PRODUCER_LIBRARY_HANDLE producerLibraryHandle, char * key, size_t * keySize);
    static PEAK_C_API PEAK_ProducerLibrary_GetSystem(PEAK_PRODUCER_LIBRARY_HANDLE producerLibraryHandle, PEAK_SYSTEM_DESCRIPTOR_HANDLE * systemDescriptorHandle);
    static PEAK_C_API PEAK_ProducerLibrary_Destruct(PEAK_PRODUCER_LIBRARY_HANDLE producerLibraryHandle);
    static PEAK_C_API PEAK_SystemDescriptor_ToModuleDescriptor(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, PEAK_MODULE_DESCRIPTOR_HANDLE * moduleDescriptorHandle);
    static PEAK_C_API PEAK_SystemDescriptor_GetKey(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * key, size_t * keySize);
    static PEAK_C_API PEAK_SystemDescriptor_GetInfo(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_SystemDescriptor_GetDisplayName(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * displayName, size_t * displayNameSize);
    static PEAK_C_API PEAK_SystemDescriptor_GetVendorName(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * vendorName, size_t * vendorNameSize);
    static PEAK_C_API PEAK_SystemDescriptor_GetModelName(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * modelName, size_t * modelNameSize);
    static PEAK_C_API PEAK_SystemDescriptor_GetVersion(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * version, size_t * versionSize);
    static PEAK_C_API PEAK_SystemDescriptor_GetTLType(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * tlType, size_t * tlTypeSize);
    static PEAK_C_API PEAK_SystemDescriptor_GetCTIFileName(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * ctiFileName, size_t * ctiFileNameSize);
    static PEAK_C_API PEAK_SystemDescriptor_GetCTIFullPath(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * ctiFullPath, size_t * ctiFullPathSize);
    static PEAK_C_API PEAK_SystemDescriptor_GetGenTLVersionMajor(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, uint32_t * gentlVersionMajor);
    static PEAK_C_API PEAK_SystemDescriptor_GetGenTLVersionMinor(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, uint32_t * gentlVersionMinor);
    static PEAK_C_API PEAK_SystemDescriptor_GetCharacterEncoding(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, PEAK_CHARACTER_ENCODING * characterEncoding);
    static PEAK_C_API PEAK_SystemDescriptor_GetParentLibrary(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, PEAK_PRODUCER_LIBRARY_HANDLE * producerLibraryHandle);
    static PEAK_C_API PEAK_SystemDescriptor_OpenSystem(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, PEAK_SYSTEM_HANDLE * systemHandle);
    static PEAK_C_API PEAK_System_ToModule(PEAK_SYSTEM_HANDLE systemHandle, PEAK_MODULE_HANDLE * moduleHandle);
    static PEAK_C_API PEAK_System_ToEventSupportingModule(PEAK_SYSTEM_HANDLE systemHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle);
    static PEAK_C_API PEAK_System_GetKey(PEAK_SYSTEM_HANDLE systemHandle, char * key, size_t * keySize);
    static PEAK_C_API PEAK_System_GetInfo(PEAK_SYSTEM_HANDLE systemHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_System_GetID(PEAK_SYSTEM_HANDLE systemHandle, char * id, size_t * idSize);
    static PEAK_C_API PEAK_System_GetDisplayName(PEAK_SYSTEM_HANDLE systemHandle, char * displayName, size_t * displayNameSize);
    static PEAK_C_API PEAK_System_GetVendorName(PEAK_SYSTEM_HANDLE systemHandle, char * vendorName, size_t * vendorNameSize);
    static PEAK_C_API PEAK_System_GetModelName(PEAK_SYSTEM_HANDLE systemHandle, char * modelName, size_t * modelNameSize);
    static PEAK_C_API PEAK_System_GetVersion(PEAK_SYSTEM_HANDLE systemHandle, char * version, size_t * versionSize);
    static PEAK_C_API PEAK_System_GetTLType(PEAK_SYSTEM_HANDLE systemHandle, char * tlType, size_t * tlTypeSize);
    static PEAK_C_API PEAK_System_GetCTIFileName(PEAK_SYSTEM_HANDLE systemHandle, char * ctiFileName, size_t * ctiFileNameSize);
    static PEAK_C_API PEAK_System_GetCTIFullPath(PEAK_SYSTEM_HANDLE systemHandle, char * ctiFullPath, size_t * ctiFullPathSize);
    static PEAK_C_API PEAK_System_GetGenTLVersionMajor(PEAK_SYSTEM_HANDLE systemHandle, uint32_t * gentlVersionMajor);
    static PEAK_C_API PEAK_System_GetGenTLVersionMinor(PEAK_SYSTEM_HANDLE systemHandle, uint32_t * gentlVersionMinor);
    static PEAK_C_API PEAK_System_GetCharacterEncoding(PEAK_SYSTEM_HANDLE systemHandle, PEAK_CHARACTER_ENCODING * characterEncoding);
    static PEAK_C_API PEAK_System_GetParentLibrary(PEAK_SYSTEM_HANDLE systemHandle, PEAK_PRODUCER_LIBRARY_HANDLE * producerLibraryHandle);
    static PEAK_C_API PEAK_System_UpdateInterfaces(PEAK_SYSTEM_HANDLE systemHandle, uint64_t timeout_ms);
    static PEAK_C_API PEAK_System_GetNumInterfaces(PEAK_SYSTEM_HANDLE systemHandle, size_t * numInterfaces);
    static PEAK_C_API PEAK_System_GetInterface(PEAK_SYSTEM_HANDLE systemHandle, size_t index, PEAK_INTERFACE_DESCRIPTOR_HANDLE * interfaceDescriptorHandle);
    static PEAK_C_API PEAK_System_RegisterInterfaceFoundCallback(PEAK_SYSTEM_HANDLE systemHandle, PEAK_INTERFACE_FOUND_CALLBACK callback, void * callbackContext, PEAK_INTERFACE_FOUND_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_System_UnregisterInterfaceFoundCallback(PEAK_SYSTEM_HANDLE systemHandle, PEAK_INTERFACE_FOUND_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_System_RegisterInterfaceLostCallback(PEAK_SYSTEM_HANDLE systemHandle, PEAK_INTERFACE_LOST_CALLBACK callback, void * callbackContext, PEAK_INTERFACE_LOST_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_System_UnregisterInterfaceLostCallback(PEAK_SYSTEM_HANDLE systemHandle, PEAK_INTERFACE_LOST_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_System_Destruct(PEAK_SYSTEM_HANDLE systemHandle);
    static PEAK_C_API PEAK_InterfaceDescriptor_ToModuleDescriptor(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, PEAK_MODULE_DESCRIPTOR_HANDLE * moduleDescriptorHandle);
    static PEAK_C_API PEAK_InterfaceDescriptor_GetKey(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, char * key, size_t * keySize);
    static PEAK_C_API PEAK_InterfaceDescriptor_GetInfo(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_InterfaceDescriptor_GetDisplayName(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, char * displayName, size_t * displayNameSize);
    static PEAK_C_API PEAK_InterfaceDescriptor_GetTLType(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, char * tlType, size_t * tlTypeSize);
    static PEAK_C_API PEAK_InterfaceDescriptor_GetParentSystem(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, PEAK_SYSTEM_HANDLE * systemHandle);
    static PEAK_C_API PEAK_InterfaceDescriptor_OpenInterface(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, PEAK_INTERFACE_HANDLE * interfaceHandle);
    static PEAK_C_API PEAK_Interface_ToModule(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_MODULE_HANDLE * moduleHandle);
    static PEAK_C_API PEAK_Interface_ToEventSupportingModule(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle);
    static PEAK_C_API PEAK_Interface_GetKey(PEAK_INTERFACE_HANDLE interfaceHandle, char * key, size_t * keySize);
    static PEAK_C_API PEAK_Interface_GetInfo(PEAK_INTERFACE_HANDLE interfaceHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_Interface_GetID(PEAK_INTERFACE_HANDLE interfaceHandle, char * id, size_t * idSize);
    static PEAK_C_API PEAK_Interface_GetDisplayName(PEAK_INTERFACE_HANDLE interfaceHandle, char * displayName, size_t * displayNameSize);
    static PEAK_C_API PEAK_Interface_GetTLType(PEAK_INTERFACE_HANDLE interfaceHandle, char * tlType, size_t * tlTypeSize);
    static PEAK_C_API PEAK_Interface_GetParentSystem(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_SYSTEM_HANDLE * systemHandle);
    static PEAK_C_API PEAK_Interface_UpdateDevices(PEAK_INTERFACE_HANDLE interfaceHandle, uint64_t timeout_ms);
    static PEAK_C_API PEAK_Interface_GetNumDevices(PEAK_INTERFACE_HANDLE interfaceHandle, size_t * numDevices);
    static PEAK_C_API PEAK_Interface_GetDevice(PEAK_INTERFACE_HANDLE interfaceHandle, size_t index, PEAK_DEVICE_DESCRIPTOR_HANDLE * deviceDescriptorHandle);
    static PEAK_C_API PEAK_Interface_RegisterDeviceFoundCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_FOUND_CALLBACK callback, void * callbackContext, PEAK_DEVICE_FOUND_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_Interface_UnregisterDeviceFoundCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_FOUND_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_Interface_RegisterDeviceReconnectedCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_RECONNECTED_CALLBACK callback, void * callbackContext, PEAK_DEVICE_RECONNECTED_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_Interface_UnregisterDeviceReconnectedCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_RECONNECTED_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_Interface_RegisterDeviceDisconnectedCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_DISCONNETED_CALLBACK callback, void * callbackContext, PEAK_DEVICE_DISCONNECTED_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_Interface_UnregisterDeviceDisconnectedCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_DISCONNECTED_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_Interface_RegisterDeviceLostCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LOST_CALLBACK callback, void * callbackContext, PEAK_DEVICE_LOST_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_Interface_UnregisterDeviceLostCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LOST_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_Interface_RegisterDeviceListChangedCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LIST_CHANGED_CALLBACK callback, void * callbackContext, PEAK_DEVICE_LIST_CHANGED_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_Interface_UnregisterDeviceListChangedCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LIST_CHANGED_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_Interface_Destruct(PEAK_INTERFACE_HANDLE interfaceHandle);
    static PEAK_C_API PEAK_DeviceDescriptor_ToModuleDescriptor(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_MODULE_DESCRIPTOR_HANDLE * moduleDescriptorHandle);
    static PEAK_C_API PEAK_DeviceDescriptor_GetKey(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * key, size_t * keySize);
    static PEAK_C_API PEAK_DeviceDescriptor_GetInfo(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_DeviceDescriptor_GetDisplayName(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * displayName, size_t * displayNameSize);
    static PEAK_C_API PEAK_DeviceDescriptor_GetVendorName(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * vendorName, size_t * vendorNameSize);
    static PEAK_C_API PEAK_DeviceDescriptor_GetModelName(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * modelName, size_t * modelNameSize);
    static PEAK_C_API PEAK_DeviceDescriptor_GetVersion(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * version, size_t * versionSize);
    static PEAK_C_API PEAK_DeviceDescriptor_GetTLType(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * tlType, size_t * tlTypeSize);
    static PEAK_C_API PEAK_DeviceDescriptor_GetUserDefinedName(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * userDefinedName, size_t * userDefinedNameSize);
    static PEAK_C_API PEAK_DeviceDescriptor_GetSerialNumber(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * serialNumber, size_t * serialNumberSize);
    static PEAK_C_API PEAK_DeviceDescriptor_GetAccessStatus(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_ACCESS_STATUS * accessStatus);
    static PEAK_C_API PEAK_DeviceDescriptor_GetTimestampTickFrequency(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, uint64_t * timestampTickFrequency);
    static PEAK_C_API PEAK_DeviceDescriptor_GetIsOpenableExclusive(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_BOOL8 * isOpenable);
    static PEAK_C_API PEAK_DeviceDescriptor_GetIsOpenable(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_ACCESS_TYPE accessType, PEAK_BOOL8 * isOpenable);
    static PEAK_C_API PEAK_DeviceDescriptor_OpenDevice(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_ACCESS_TYPE accessType, PEAK_DEVICE_HANDLE * deviceHandle);
    static PEAK_C_API PEAK_DeviceDescriptor_GetParentInterface(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_INTERFACE_HANDLE * interfaceHandle);
    static PEAK_C_API PEAK_DeviceDescriptor_GetMonitoringUpdateInterval(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, uint64_t * monitoringUpdateInterval_ms);
    static PEAK_C_API PEAK_DeviceDescriptor_SetMonitoringUpdateInterval(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, uint64_t monitoringUpdateInterval_ms);
    static PEAK_C_API PEAK_DeviceDescriptor_IsInformationRoleMonitored(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_INFORMATION_ROLE informationRole, PEAK_BOOL8 * isInformationRoleMonitored);
    static PEAK_C_API PEAK_DeviceDescriptor_AddInformationRoleToMonitoring(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_INFORMATION_ROLE informationRole);
    static PEAK_C_API PEAK_DeviceDescriptor_RemoveInformationRoleFromMonitoring(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_INFORMATION_ROLE informationRole);
    static PEAK_C_API PEAK_DeviceDescriptor_RegisterInformationChangedCallback(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_DESCRIPTOR_INFORMATION_CHANGED_CALLBACK callback, void * callbackContext, PEAK_DEVICE_DESCRIPTOR_INFORMATION_CHANGED_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_DeviceDescriptor_UnregisterInformationChangedCallback(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_DESCRIPTOR_INFORMATION_CHANGED_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_Device_ToModule(PEAK_DEVICE_HANDLE deviceHandle, PEAK_MODULE_HANDLE * moduleHandle);
    static PEAK_C_API PEAK_Device_ToEventSupportingModule(PEAK_DEVICE_HANDLE deviceHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle);
    static PEAK_C_API PEAK_Device_GetKey(PEAK_DEVICE_HANDLE deviceHandle, char * key, size_t * keySize);
    static PEAK_C_API PEAK_Device_GetInfo(PEAK_DEVICE_HANDLE deviceHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_Device_GetID(PEAK_DEVICE_HANDLE deviceHandle, char * id, size_t * idSize);
    static PEAK_C_API PEAK_Device_GetDisplayName(PEAK_DEVICE_HANDLE deviceHandle, char * displayName, size_t * displayNameSize);
    static PEAK_C_API PEAK_Device_GetVendorName(PEAK_DEVICE_HANDLE deviceHandle, char * vendorName, size_t * vendorNameSize);
    static PEAK_C_API PEAK_Device_GetModelName(PEAK_DEVICE_HANDLE deviceHandle, char * modelName, size_t * modelNameSize);
    static PEAK_C_API PEAK_Device_GetVersion(PEAK_DEVICE_HANDLE deviceHandle, char * version, size_t * versionSize);
    static PEAK_C_API PEAK_Device_GetTLType(PEAK_DEVICE_HANDLE deviceHandle, char * tlType, size_t * tlTypeSize);
    static PEAK_C_API PEAK_Device_GetUserDefinedName(PEAK_DEVICE_HANDLE deviceHandle, char * userDefinedName, size_t * userDefinedNameSize);
    static PEAK_C_API PEAK_Device_GetSerialNumber(PEAK_DEVICE_HANDLE deviceHandle, char * serialNumber, size_t * serialNumberSize);
    static PEAK_C_API PEAK_Device_GetAccessStatus(PEAK_DEVICE_HANDLE deviceHandle, PEAK_DEVICE_ACCESS_STATUS * accessStatus);
    static PEAK_C_API PEAK_Device_GetTimestampTickFrequency(PEAK_DEVICE_HANDLE deviceHandle, uint64_t * timestampTickFrequency);
    static PEAK_C_API PEAK_Device_GetParentInterface(PEAK_DEVICE_HANDLE deviceHandle, PEAK_INTERFACE_HANDLE * interfaceHandle);
    static PEAK_C_API PEAK_Device_GetRemoteDevice(PEAK_DEVICE_HANDLE deviceHandle, PEAK_REMOTE_DEVICE_HANDLE * remoteDeviceHandle);
    static PEAK_C_API PEAK_Device_GetNumDataStreams(PEAK_DEVICE_HANDLE deviceHandle, size_t * numDataStreams);
    static PEAK_C_API PEAK_Device_GetDataStream(PEAK_DEVICE_HANDLE deviceHandle, size_t index, PEAK_DATA_STREAM_DESCRIPTOR_HANDLE * dataStreamDescriptorHandle);
    static PEAK_C_API PEAK_Device_Destruct(PEAK_DEVICE_HANDLE deviceHandle);
    static PEAK_C_API PEAK_RemoteDevice_ToModule(PEAK_REMOTE_DEVICE_HANDLE remoteDeviceHandle, PEAK_MODULE_HANDLE * moduleHandle);
    static PEAK_C_API PEAK_RemoteDevice_GetLocalDevice(PEAK_REMOTE_DEVICE_HANDLE remoteDeviceHandle, PEAK_DEVICE_HANDLE * deviceHandle);
    static PEAK_C_API PEAK_DataStreamDescriptor_ToModuleDescriptor(PEAK_DATA_STREAM_DESCRIPTOR_HANDLE dataStreamDescriptorHandle, PEAK_MODULE_DESCRIPTOR_HANDLE * moduleDescriptorHandle);
    static PEAK_C_API PEAK_DataStreamDescriptor_GetKey(PEAK_DATA_STREAM_DESCRIPTOR_HANDLE dataStreamDescriptorHandle, char * key, size_t * keySize);
    static PEAK_C_API PEAK_DataStreamDescriptor_GetParentDevice(PEAK_DATA_STREAM_DESCRIPTOR_HANDLE dataStreamDescriptorHandle, PEAK_DEVICE_HANDLE * deviceHandle);
    static PEAK_C_API PEAK_DataStreamDescriptor_OpenDataStream(PEAK_DATA_STREAM_DESCRIPTOR_HANDLE dataStreamDescriptorHandle, PEAK_DATA_STREAM_HANDLE * dataStreamHandle);
    static PEAK_C_API PEAK_DataStream_ToModule(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_MODULE_HANDLE * moduleHandle);
    static PEAK_C_API PEAK_DataStream_ToEventSupportingModule(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle);
    static PEAK_C_API PEAK_DataStream_GetKey(PEAK_DATA_STREAM_HANDLE dataStreamHandle, char * key, size_t * keySize);
    static PEAK_C_API PEAK_DataStream_GetInfo(PEAK_DATA_STREAM_HANDLE dataStreamHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_DataStream_GetID(PEAK_DATA_STREAM_HANDLE dataStreamHandle, char * id, size_t * idSize);
    static PEAK_C_API PEAK_DataStream_GetTLType(PEAK_DATA_STREAM_HANDLE dataStreamHandle, char * tlType, size_t * tlTypeSize);
    static PEAK_C_API PEAK_DataStream_GetNumBuffersAnnouncedMinRequired(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numBuffersAnnouncedMinRequired);
    static PEAK_C_API PEAK_DataStream_GetNumBuffersAnnounced(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numBuffersAnnounced);
    static PEAK_C_API PEAK_DataStream_GetNumBuffersQueued(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numBuffersQueued);
    static PEAK_C_API PEAK_DataStream_GetNumBuffersAwaitDelivery(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numBuffersAwaitDelivery);
    static PEAK_C_API PEAK_DataStream_GetNumBuffersDelivered(PEAK_DATA_STREAM_HANDLE dataStreamHandle, uint64_t * numBuffersDelivered);
    static PEAK_C_API PEAK_DataStream_GetNumBuffersStarted(PEAK_DATA_STREAM_HANDLE dataStreamHandle, uint64_t * numBuffersStarted);
    static PEAK_C_API PEAK_DataStream_GetNumUnderruns(PEAK_DATA_STREAM_HANDLE dataStreamHandle, uint64_t * numUnderruns);
    static PEAK_C_API PEAK_DataStream_GetNumChunksPerBufferMax(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numChunksPerBufferMax);
    static PEAK_C_API PEAK_DataStream_GetBufferAlignment(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * bufferAlignment);
    static PEAK_C_API PEAK_DataStream_GetPayloadSize(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * payloadSize);
    static PEAK_C_API PEAK_DataStream_GetDefinesPayloadSize(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_BOOL8 * definesPayloadSize);
    static PEAK_C_API PEAK_DataStream_GetIsGrabbing(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_BOOL8 * isGrabbing);
    static PEAK_C_API PEAK_DataStream_GetParentDevice(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_DEVICE_HANDLE * deviceHandle);
    static PEAK_C_API PEAK_DataStream_AnnounceBuffer(PEAK_DATA_STREAM_HANDLE dataStreamHandle, void * buffer, size_t bufferSize, void * userPtr, PEAK_BUFFER_REVOCATION_CALLBACK revocationCallback, void * callbackContext, PEAK_BUFFER_HANDLE * bufferHandle);
    static PEAK_C_API PEAK_DataStream_AllocAndAnnounceBuffer(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t bufferSize, void * userPtr, PEAK_BUFFER_HANDLE * bufferHandle);
    static PEAK_C_API PEAK_DataStream_QueueBuffer(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_BUFFER_HANDLE bufferHandle);
    static PEAK_C_API PEAK_DataStream_RevokeBuffer(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_BUFFER_HANDLE bufferHandle);
    static PEAK_C_API PEAK_DataStream_WaitForFinishedBuffer(PEAK_DATA_STREAM_HANDLE dataStreamHandle, uint64_t timeout_ms, PEAK_BUFFER_HANDLE * bufferHandle);
    static PEAK_C_API PEAK_DataStream_KillWait(PEAK_DATA_STREAM_HANDLE dataStreamHandle);
    static PEAK_C_API PEAK_DataStream_Flush(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_DATA_STREAM_FLUSH_MODE flushMode);
    static PEAK_C_API PEAK_DataStream_StartAcquisitionInfinite(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_ACQUISITION_START_MODE startMode);
    static PEAK_C_API PEAK_DataStream_StartAcquisition(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_ACQUISITION_START_MODE startMode, uint64_t numToAcquire);
    static PEAK_C_API PEAK_DataStream_StopAcquisition(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_ACQUISITION_STOP_MODE stopMode);
    static PEAK_C_API PEAK_DataStream_Destruct(PEAK_DATA_STREAM_HANDLE dataStreamHandle);
    static PEAK_C_API PEAK_Buffer_ToModule(PEAK_BUFFER_HANDLE bufferHandle, PEAK_MODULE_HANDLE * moduleHandle);
    static PEAK_C_API PEAK_Buffer_ToEventSupportingModule(PEAK_BUFFER_HANDLE bufferHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle);
    static PEAK_C_API PEAK_Buffer_GetInfo(PEAK_BUFFER_HANDLE bufferHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_Buffer_GetTLType(PEAK_BUFFER_HANDLE bufferHandle, char * tlType, size_t * tlTypeSize);
    static PEAK_C_API PEAK_Buffer_GetBasePtr(PEAK_BUFFER_HANDLE bufferHandle, void * * basePtr);
    static PEAK_C_API PEAK_Buffer_GetSize(PEAK_BUFFER_HANDLE bufferHandle, size_t * size);
    static PEAK_C_API PEAK_Buffer_GetUserPtr(PEAK_BUFFER_HANDLE bufferHandle, void * * userPtr);
    static PEAK_C_API PEAK_Buffer_GetPayloadType(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BUFFER_PAYLOAD_TYPE * payloadType);
    static PEAK_C_API PEAK_Buffer_GetPixelFormat(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * pixelFormat);
    static PEAK_C_API PEAK_Buffer_GetPixelFormatNamespace(PEAK_BUFFER_HANDLE bufferHandle, PEAK_PIXEL_FORMAT_NAMESPACE * pixelFormatNamespace);
    static PEAK_C_API PEAK_Buffer_GetPixelEndianness(PEAK_BUFFER_HANDLE bufferHandle, PEAK_ENDIANNESS * pixelEndianness);
    static PEAK_C_API PEAK_Buffer_GetExpectedDataSize(PEAK_BUFFER_HANDLE bufferHandle, size_t * expectedDataSize);
    static PEAK_C_API PEAK_Buffer_GetDeliveredDataSize(PEAK_BUFFER_HANDLE bufferHandle, size_t * deliveredDataSize);
    static PEAK_C_API PEAK_Buffer_GetFrameID(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * frameId);
    static PEAK_C_API PEAK_Buffer_GetImageOffset(PEAK_BUFFER_HANDLE bufferHandle, size_t * imageOffset);
    static PEAK_C_API PEAK_Buffer_GetDeliveredImageHeight(PEAK_BUFFER_HANDLE bufferHandle, size_t * deliveredImageHeight);
    static PEAK_C_API PEAK_Buffer_GetDeliveredChunkPayloadSize(PEAK_BUFFER_HANDLE bufferHandle, size_t * deliveredChunkPayloadSize);
    static PEAK_C_API PEAK_Buffer_GetChunkLayoutID(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * chunkLayoutId);
    static PEAK_C_API PEAK_Buffer_GetFileName(PEAK_BUFFER_HANDLE bufferHandle, char * fileName, size_t * fileNameSize);
    static PEAK_C_API PEAK_Buffer_GetWidth(PEAK_BUFFER_HANDLE bufferHandle, size_t * width);
    static PEAK_C_API PEAK_Buffer_GetHeight(PEAK_BUFFER_HANDLE bufferHandle, size_t * height);
    static PEAK_C_API PEAK_Buffer_GetXOffset(PEAK_BUFFER_HANDLE bufferHandle, size_t * xOffset);
    static PEAK_C_API PEAK_Buffer_GetYOffset(PEAK_BUFFER_HANDLE bufferHandle, size_t * yOffset);
    static PEAK_C_API PEAK_Buffer_GetXPadding(PEAK_BUFFER_HANDLE bufferHandle, size_t * xPadding);
    static PEAK_C_API PEAK_Buffer_GetYPadding(PEAK_BUFFER_HANDLE bufferHandle, size_t * yPadding);
    static PEAK_C_API PEAK_Buffer_GetTimestamp_ticks(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * timestamp_ticks);
    static PEAK_C_API PEAK_Buffer_GetTimestamp_ns(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * timestamp_ns);
    static PEAK_C_API PEAK_Buffer_GetIsQueued(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * isQueued);
    static PEAK_C_API PEAK_Buffer_GetIsAcquiring(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * isAcquiring);
    static PEAK_C_API PEAK_Buffer_GetIsIncomplete(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * isIncomplete);
    static PEAK_C_API PEAK_Buffer_GetHasNewData(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasNewData);
    static PEAK_C_API PEAK_Buffer_GetHasImage(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasImage);
    static PEAK_C_API PEAK_Buffer_GetHasChunks(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasChunks);
    static PEAK_C_API PEAK_Buffer_GetHasParts(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasParts);
    static PEAK_C_API PEAK_Buffer_UpdateChunks(PEAK_BUFFER_HANDLE bufferHandle);
    static PEAK_C_API PEAK_Buffer_GetNumChunks(PEAK_BUFFER_HANDLE bufferHandle, size_t * numChunks);
    static PEAK_C_API PEAK_Buffer_GetChunk(PEAK_BUFFER_HANDLE bufferHandle, size_t index, PEAK_BUFFER_CHUNK_HANDLE * bufferChunkHandle);
    static PEAK_C_API PEAK_Buffer_UpdateParts(PEAK_BUFFER_HANDLE bufferHandle);
    static PEAK_C_API PEAK_Buffer_GetNumParts(PEAK_BUFFER_HANDLE bufferHandle, size_t * numParts);
    static PEAK_C_API PEAK_Buffer_GetPart(PEAK_BUFFER_HANDLE bufferHandle, size_t index, PEAK_BUFFER_PART_HANDLE * bufferPartHandle);
    static PEAK_C_API PEAK_BufferChunk_GetID(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle, uint64_t * id);
    static PEAK_C_API PEAK_BufferChunk_GetBasePtr(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle, void * * basePtr);
    static PEAK_C_API PEAK_BufferChunk_GetSize(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle, size_t * size);
    static PEAK_C_API PEAK_BufferChunk_GetParentBuffer(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle, PEAK_BUFFER_HANDLE * bufferHandle);
    static PEAK_C_API PEAK_BufferChunk_Destruct(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle);
    static PEAK_C_API PEAK_BufferPart_GetInfo(PEAK_BUFFER_PART_HANDLE bufferPartHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_BufferPart_GetSourceID(PEAK_BUFFER_PART_HANDLE bufferPartHandle, uint64_t * sourceId);
    static PEAK_C_API PEAK_BufferPart_GetBasePtr(PEAK_BUFFER_PART_HANDLE bufferPartHandle, void * * basePtr);
    static PEAK_C_API PEAK_BufferPart_GetSize(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * size);
    static PEAK_C_API PEAK_BufferPart_GetType(PEAK_BUFFER_PART_HANDLE bufferPartHandle, PEAK_BUFFER_PART_TYPE * type);
    static PEAK_C_API PEAK_BufferPart_GetFormat(PEAK_BUFFER_PART_HANDLE bufferPartHandle, uint64_t * format);
    static PEAK_C_API PEAK_BufferPart_GetFormatNamespace(PEAK_BUFFER_PART_HANDLE bufferPartHandle, uint64_t * formatNamespace);
    static PEAK_C_API PEAK_BufferPart_GetWidth(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * width);
    static PEAK_C_API PEAK_BufferPart_GetHeight(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * height);
    static PEAK_C_API PEAK_BufferPart_GetXOffset(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * xOffset);
    static PEAK_C_API PEAK_BufferPart_GetYOffset(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * yOffset);
    static PEAK_C_API PEAK_BufferPart_GetXPadding(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * xPadding);
    static PEAK_C_API PEAK_BufferPart_GetDeliveredImageHeight(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * deliveredImageHeight);
    static PEAK_C_API PEAK_BufferPart_GetParentBuffer(PEAK_BUFFER_PART_HANDLE bufferPartHandle, PEAK_BUFFER_HANDLE * bufferHandle);
    static PEAK_C_API PEAK_BufferPart_Destruct(PEAK_BUFFER_PART_HANDLE bufferPartHandle);
    static PEAK_C_API PEAK_ModuleDescriptor_GetID(PEAK_MODULE_DESCRIPTOR_HANDLE moduleDescriptorHandle, char * id, size_t * idSize);
    static PEAK_C_API PEAK_Module_GetNumNodeMaps(PEAK_MODULE_HANDLE moduleHandle, size_t * numNodeMaps);
    static PEAK_C_API PEAK_Module_GetNodeMap(PEAK_MODULE_HANDLE moduleHandle, size_t index, PEAK_NODE_MAP_HANDLE * nodeMapHandle);
    static PEAK_C_API PEAK_Module_GetPort(PEAK_MODULE_HANDLE moduleHandle, PEAK_PORT_HANDLE * portHandle);
    static PEAK_C_API PEAK_NodeMap_GetHasNode(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * nodeName, size_t nodeNameSize, PEAK_BOOL8 * hasNode);
    static PEAK_C_API PEAK_NodeMap_FindNode(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * nodeName, size_t nodeNameSize, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_NodeMap_TryFindNode(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * nodeName, size_t nodeNameSize, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_NodeMap_InvalidateNodes(PEAK_NODE_MAP_HANDLE nodeMapHandle);
    static PEAK_C_API PEAK_NodeMap_PollNodes(PEAK_NODE_MAP_HANDLE nodeMapHandle, int64_t elapsedTime_ms);
    static PEAK_C_API PEAK_NodeMap_GetNumNodes(PEAK_NODE_MAP_HANDLE nodeMapHandle, size_t * numNodes);
    static PEAK_C_API PEAK_NodeMap_GetNode(PEAK_NODE_MAP_HANDLE nodeMapHandle, size_t index, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_NodeMap_GetHasBufferSupportedChunks(PEAK_NODE_MAP_HANDLE nodeMapHandle, PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasSupportedChunks);
    static PEAK_C_API PEAK_NodeMap_UpdateChunkNodes(PEAK_NODE_MAP_HANDLE nodeMapHandle, PEAK_BUFFER_HANDLE bufferHandle);
    static PEAK_C_API PEAK_NodeMap_GetHasEventSupportedData(PEAK_NODE_MAP_HANDLE nodeMapHandle, PEAK_EVENT_HANDLE eventHandle, PEAK_BOOL8 * hasSupportedData);
    static PEAK_C_API PEAK_NodeMap_UpdateEventNodes(PEAK_NODE_MAP_HANDLE nodeMapHandle, PEAK_EVENT_HANDLE eventHandle);
    static PEAK_C_API PEAK_NodeMap_StoreToFile(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * filePath, size_t filePathSize);
    static PEAK_C_API PEAK_NodeMap_LoadFromFile(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * filePath, size_t filePathSize);
    static PEAK_C_API PEAK_NodeMap_Lock(PEAK_NODE_MAP_HANDLE nodeMapHandle);
    static PEAK_C_API PEAK_NodeMap_Unlock(PEAK_NODE_MAP_HANDLE nodeMapHandle);
    static PEAK_C_API PEAK_Node_ToIntegerNode(PEAK_NODE_HANDLE nodeHandle, PEAK_INTEGER_NODE_HANDLE * integerNodeHandle);
    static PEAK_C_API PEAK_Node_ToBooleanNode(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOLEAN_NODE_HANDLE * booleanNodeHandle);
    static PEAK_C_API PEAK_Node_ToCommandNode(PEAK_NODE_HANDLE nodeHandle, PEAK_COMMAND_NODE_HANDLE * commandNodeHandle);
    static PEAK_C_API PEAK_Node_ToFloatNode(PEAK_NODE_HANDLE nodeHandle, PEAK_FLOAT_NODE_HANDLE * floatNodeHandle);
    static PEAK_C_API PEAK_Node_ToStringNode(PEAK_NODE_HANDLE nodeHandle, PEAK_STRING_NODE_HANDLE * stringNodeHandle);
    static PEAK_C_API PEAK_Node_ToRegisterNode(PEAK_NODE_HANDLE nodeHandle, PEAK_REGISTER_NODE_HANDLE * registerNodeHandle);
    static PEAK_C_API PEAK_Node_ToCategoryNode(PEAK_NODE_HANDLE nodeHandle, PEAK_CATEGORY_NODE_HANDLE * categoryNodeHandle);
    static PEAK_C_API PEAK_Node_ToEnumerationNode(PEAK_NODE_HANDLE nodeHandle, PEAK_ENUMERATION_NODE_HANDLE * enumerationNodeHandle);
    static PEAK_C_API PEAK_Node_ToEnumerationEntryNode(PEAK_NODE_HANDLE nodeHandle, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
    static PEAK_C_API PEAK_Node_GetName(PEAK_NODE_HANDLE nodeHandle, char * name, size_t * nameSize);
    static PEAK_C_API PEAK_Node_GetDisplayName(PEAK_NODE_HANDLE nodeHandle, char * displayName, size_t * displayNameSize);
    static PEAK_C_API PEAK_Node_GetNamespace(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_NAMESPACE * _namespace);
    static PEAK_C_API PEAK_Node_GetVisibility(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_VISIBILITY * visibility);
    static PEAK_C_API PEAK_Node_GetAccessStatus(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_ACCESS_STATUS * accessStatus);
    static PEAK_C_API PEAK_Node_GetIsCacheable(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isCacheable);
    static PEAK_C_API PEAK_Node_GetIsAccessStatusCacheable(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isAccessStatusCacheable);
    static PEAK_C_API PEAK_Node_GetIsStreamable(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isStreamable);
    static PEAK_C_API PEAK_Node_GetIsDeprecated(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isDeprecated);
    static PEAK_C_API PEAK_Node_GetIsFeature(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isFeature);
    static PEAK_C_API PEAK_Node_GetCachingMode(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_CACHING_MODE * cachingMode);
    static PEAK_C_API PEAK_Node_GetPollingTime(PEAK_NODE_HANDLE nodeHandle, int64_t * pollingTime_ms);
    static PEAK_C_API PEAK_Node_GetToolTip(PEAK_NODE_HANDLE nodeHandle, char * toolTip, size_t * toolTipSize);
    static PEAK_C_API PEAK_Node_GetDescription(PEAK_NODE_HANDLE nodeHandle, char * description, size_t * descriptionSize);
    static PEAK_C_API PEAK_Node_GetType(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_TYPE * type);
    static PEAK_C_API PEAK_Node_GetParentNodeMap(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_MAP_HANDLE * nodeMapHandle);
    static PEAK_C_API PEAK_Node_FindInvalidatedNode(PEAK_NODE_HANDLE nodeHandle, const char * name, size_t nameSize, PEAK_NODE_HANDLE * invalidatedNodeHandle);
    static PEAK_C_API PEAK_Node_GetNumInvalidatedNodes(PEAK_NODE_HANDLE nodeHandle, size_t * numInvalidatedNodes);
    static PEAK_C_API PEAK_Node_GetInvalidatedNode(PEAK_NODE_HANDLE nodeHandle, size_t index, PEAK_NODE_HANDLE * invalidatedNodeHandle);
    static PEAK_C_API PEAK_Node_FindInvalidatingNode(PEAK_NODE_HANDLE nodeHandle, const char * name, size_t nameSize, PEAK_NODE_HANDLE * invalidatingNodeHandle);
    static PEAK_C_API PEAK_Node_GetNumInvalidatingNodes(PEAK_NODE_HANDLE nodeHandle, size_t * numInvalidatingNodes);
    static PEAK_C_API PEAK_Node_GetInvalidatingNode(PEAK_NODE_HANDLE nodeHandle, size_t index, PEAK_NODE_HANDLE * invalidatingNodeHandle);
    static PEAK_C_API PEAK_Node_FindSelectedNode(PEAK_NODE_HANDLE nodeHandle, const char * name, size_t nameSize, PEAK_NODE_HANDLE * selectedNodeHandle);
    static PEAK_C_API PEAK_Node_GetNumSelectedNodes(PEAK_NODE_HANDLE nodeHandle, size_t * numSelectedNodes);
    static PEAK_C_API PEAK_Node_GetSelectedNode(PEAK_NODE_HANDLE nodeHandle, size_t index, PEAK_NODE_HANDLE * selectedNodeHandle);
    static PEAK_C_API PEAK_Node_FindSelectingNode(PEAK_NODE_HANDLE nodeHandle, const char * name, size_t nameSize, PEAK_NODE_HANDLE * selectingNodeHandle);
    static PEAK_C_API PEAK_Node_GetNumSelectingNodes(PEAK_NODE_HANDLE nodeHandle, size_t * numSelectingNodes);
    static PEAK_C_API PEAK_Node_GetSelectingNode(PEAK_NODE_HANDLE nodeHandle, size_t index, PEAK_NODE_HANDLE * selectingNodeHandle);
    static PEAK_C_API PEAK_Node_RegisterChangedCallback(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_CHANGED_CALLBACK callback, void * callbackContext, PEAK_NODE_CHANGED_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_Node_UnregisterChangedCallback(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_CHANGED_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_IntegerNode_ToNode(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_IntegerNode_GetMinimum(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t * minimum);
    static PEAK_C_API PEAK_IntegerNode_GetMaximum(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t * maximum);
    static PEAK_C_API PEAK_IntegerNode_GetIncrement(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t * increment);
    static PEAK_C_API PEAK_IntegerNode_GetIncrementType(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, PEAK_NODE_INCREMENT_TYPE * incrementType);
    static PEAK_C_API PEAK_IntegerNode_GetValidValues(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t * validValues, size_t * validValuesSize);
    static PEAK_C_API PEAK_IntegerNode_GetRepresentation(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, PEAK_NODE_REPRESENTATION * representation);
    static PEAK_C_API PEAK_IntegerNode_GetUnit(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, char * unit, size_t * unitSize);
    static PEAK_C_API PEAK_IntegerNode_GetValue(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, int64_t * value);
    static PEAK_C_API PEAK_IntegerNode_SetValue(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t value);
    static PEAK_C_API PEAK_BooleanNode_ToNode(PEAK_BOOLEAN_NODE_HANDLE booleanNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_BooleanNode_GetValue(PEAK_BOOLEAN_NODE_HANDLE booleanNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, PEAK_BOOL8 * value);
    static PEAK_C_API PEAK_BooleanNode_SetValue(PEAK_BOOLEAN_NODE_HANDLE booleanNodeHandle, PEAK_BOOL8 value);
    static PEAK_C_API PEAK_CommandNode_ToNode(PEAK_COMMAND_NODE_HANDLE commandNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_CommandNode_GetIsDone(PEAK_COMMAND_NODE_HANDLE commandNodeHandle, PEAK_BOOL8 * isDone);
    static PEAK_C_API PEAK_CommandNode_Execute(PEAK_COMMAND_NODE_HANDLE commandNodeHandle);
    static PEAK_C_API PEAK_CommandNode_WaitUntilDoneInfinite(PEAK_COMMAND_NODE_HANDLE commandNodeHandle);
    static PEAK_C_API PEAK_CommandNode_WaitUntilDone(PEAK_COMMAND_NODE_HANDLE commandNodeHandle, uint64_t waitTimeout_ms);
    static PEAK_C_API PEAK_FloatNode_ToNode(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_FloatNode_GetMinimum(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double * minimum);
    static PEAK_C_API PEAK_FloatNode_GetMaximum(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double * maximum);
    static PEAK_C_API PEAK_FloatNode_GetIncrement(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double * increment);
    static PEAK_C_API PEAK_FloatNode_GetIncrementType(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_INCREMENT_TYPE * incrementType);
    static PEAK_C_API PEAK_FloatNode_GetValidValues(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double * validValues, size_t * validValuesSize);
    static PEAK_C_API PEAK_FloatNode_GetRepresentation(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_REPRESENTATION * representation);
    static PEAK_C_API PEAK_FloatNode_GetUnit(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, char * unit, size_t * unitSize);
    static PEAK_C_API PEAK_FloatNode_GetDisplayNotation(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_DISPLAY_NOTATION * displayNotation);
    static PEAK_C_API PEAK_FloatNode_GetDisplayPrecision(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, int64_t * displayPrecision);
    static PEAK_C_API PEAK_FloatNode_GetHasConstantIncrement(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_BOOL8 * hasConstantIncrement);
    static PEAK_C_API PEAK_FloatNode_GetValue(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, double * value);
    static PEAK_C_API PEAK_FloatNode_SetValue(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double value);
    static PEAK_C_API PEAK_StringNode_ToNode(PEAK_STRING_NODE_HANDLE stringNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_StringNode_GetMaximumLength(PEAK_STRING_NODE_HANDLE stringNodeHandle, int64_t * maximumLength);
    static PEAK_C_API PEAK_StringNode_GetValue(PEAK_STRING_NODE_HANDLE stringNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, char * value, size_t * valueSize);
    static PEAK_C_API PEAK_StringNode_SetValue(PEAK_STRING_NODE_HANDLE stringNodeHandle, const char * value, size_t valueSize);
    static PEAK_C_API PEAK_RegisterNode_ToNode(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_RegisterNode_GetAddress(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, uint64_t * address);
    static PEAK_C_API PEAK_RegisterNode_GetLength(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, size_t * length);
    static PEAK_C_API PEAK_RegisterNode_Read(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, uint8_t * bytesToRead, size_t bytesToReadSize);
    static PEAK_C_API PEAK_RegisterNode_Write(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, const uint8_t * bytesToWrite, size_t bytesToWriteSize);
    static PEAK_C_API PEAK_CategoryNode_ToNode(PEAK_CATEGORY_NODE_HANDLE categoryNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_CategoryNode_GetNumSubNodes(PEAK_CATEGORY_NODE_HANDLE categoryNodeHandle, size_t * numSubNodes);
    static PEAK_C_API PEAK_CategoryNode_GetSubNode(PEAK_CATEGORY_NODE_HANDLE categoryNodeHandle, size_t index, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_EnumerationNode_ToNode(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_EnumerationNode_GetCurrentEntry(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
    static PEAK_C_API PEAK_EnumerationNode_SetCurrentEntry(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle);
    static PEAK_C_API PEAK_EnumerationNode_SetCurrentEntryBySymbolicValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, const char * symbolicValue, size_t symbolicValueSize);
    static PEAK_C_API PEAK_EnumerationNode_SetCurrentEntryByValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, int64_t value);
    static PEAK_C_API PEAK_EnumerationNode_GetHasEntryBySymbolicValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, const char * symbolicValue, size_t symbolicValueSize, PEAK_BOOL8 * hasEntry);
    static PEAK_C_API PEAK_EnumerationNode_GetHasEntryByValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, int64_t value, PEAK_BOOL8 * hasEntry);
    static PEAK_C_API PEAK_EnumerationNode_FindEntryBySymbolicValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, const char * symbolicValue, size_t symbolicValueSize, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
    static PEAK_C_API PEAK_EnumerationNode_FindEntryByValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, int64_t value, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
    static PEAK_C_API PEAK_EnumerationNode_TryFindEntryBySymbolicValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, const char * symbolicValue, size_t symbolicValueSize, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
    static PEAK_C_API PEAK_EnumerationNode_TryFindEntryByValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, int64_t value, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
    static PEAK_C_API PEAK_EnumerationNode_GetNumEntries(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, size_t * numEntries);
    static PEAK_C_API PEAK_EnumerationNode_GetEntry(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, size_t index, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle);
    static PEAK_C_API PEAK_EnumerationEntryNode_ToNode(PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle, PEAK_NODE_HANDLE * nodeHandle);
    static PEAK_C_API PEAK_EnumerationEntryNode_GetIsSelfClearing(PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle, PEAK_BOOL8 * isSelfClearing);
    static PEAK_C_API PEAK_EnumerationEntryNode_GetSymbolicValue(PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle, char * symbolicValue, size_t * symbolicValueSize);
    static PEAK_C_API PEAK_EnumerationEntryNode_GetValue(PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle, int64_t * value);
    static PEAK_C_API PEAK_Port_GetInfo(PEAK_PORT_HANDLE portHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_Port_GetID(PEAK_PORT_HANDLE portHandle, char * id, size_t * idSize);
    static PEAK_C_API PEAK_Port_GetName(PEAK_PORT_HANDLE portHandle, char * name, size_t * nameSize);
    static PEAK_C_API PEAK_Port_GetVendorName(PEAK_PORT_HANDLE portHandle, char * vendorName, size_t * vendorNameSize);
    static PEAK_C_API PEAK_Port_GetModelName(PEAK_PORT_HANDLE portHandle, char * modelName, size_t * modelNameSize);
    static PEAK_C_API PEAK_Port_GetVersion(PEAK_PORT_HANDLE portHandle, char * version, size_t * versionSize);
    static PEAK_C_API PEAK_Port_GetTLType(PEAK_PORT_HANDLE portHandle, char * tlType, size_t * tlTypeSize);
    static PEAK_C_API PEAK_Port_GetModuleName(PEAK_PORT_HANDLE portHandle, char * moduleName, size_t * moduleNameSize);
    static PEAK_C_API PEAK_Port_GetDataEndianness(PEAK_PORT_HANDLE portHandle, PEAK_ENDIANNESS * dataEndianness);
    static PEAK_C_API PEAK_Port_GetIsReadable(PEAK_PORT_HANDLE portHandle, PEAK_BOOL8 * isReadable);
    static PEAK_C_API PEAK_Port_GetIsWritable(PEAK_PORT_HANDLE portHandle, PEAK_BOOL8 * isWritable);
    static PEAK_C_API PEAK_Port_GetIsAvailable(PEAK_PORT_HANDLE portHandle, PEAK_BOOL8 * isAvailable);
    static PEAK_C_API PEAK_Port_GetIsImplemented(PEAK_PORT_HANDLE portHandle, PEAK_BOOL8 * isImplemented);
    static PEAK_C_API PEAK_Port_Read(PEAK_PORT_HANDLE portHandle, uint64_t address, uint8_t * bytesToRead, size_t bytesToReadSize);
    static PEAK_C_API PEAK_Port_Write(PEAK_PORT_HANDLE portHandle, uint64_t address, const uint8_t * bytesToWrite, size_t bytesToWriteSize);
    static PEAK_C_API PEAK_Port_GetNumURLs(PEAK_PORT_HANDLE portHandle, size_t * numUrls);
    static PEAK_C_API PEAK_Port_GetURL(PEAK_PORT_HANDLE portHandle, size_t index, PEAK_PORT_URL_HANDLE * portUrlHandle);
    static PEAK_C_API PEAK_PortURL_GetInfo(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_PortURL_GetURL(PEAK_PORT_URL_HANDLE portUrlHandle, char * url, size_t * urlSize);
    static PEAK_C_API PEAK_PortURL_GetScheme(PEAK_PORT_URL_HANDLE portUrlHandle, PEAK_PORT_URL_SCHEME * scheme);
    static PEAK_C_API PEAK_PortURL_GetFileName(PEAK_PORT_URL_HANDLE portUrlHandle, char * fileName, size_t * fileNameSize);
    static PEAK_C_API PEAK_PortURL_GetFileRegisterAddress(PEAK_PORT_URL_HANDLE portUrlHandle, uint64_t * fileRegisterAddress);
    static PEAK_C_API PEAK_PortURL_GetFileSize(PEAK_PORT_URL_HANDLE portUrlHandle, uint64_t * fileSize);
    static PEAK_C_API PEAK_PortURL_GetFileSHA1Hash(PEAK_PORT_URL_HANDLE portUrlHandle, uint8_t * fileSha1Hash, size_t * fileSha1HashSize);
    static PEAK_C_API PEAK_PortURL_GetFileVersionMajor(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileVersionMajor);
    static PEAK_C_API PEAK_PortURL_GetFileVersionMinor(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileVersionMinor);
    static PEAK_C_API PEAK_PortURL_GetFileVersionSubminor(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileVersionSubminor);
    static PEAK_C_API PEAK_PortURL_GetFileSchemaVersionMajor(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileSchemaVersionMajor);
    static PEAK_C_API PEAK_PortURL_GetFileSchemaVersionMinor(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileSchemaVersionMinor);
    static PEAK_C_API PEAK_PortURL_GetParentPort(PEAK_PORT_URL_HANDLE portUrlHandle, PEAK_PORT_HANDLE * portHandle);
    static PEAK_C_API PEAK_EventSupportingModule_EnableEvents(PEAK_EVENT_SUPPORTING_MODULE_HANDLE eventSupportingModuleHandle, PEAK_EVENT_TYPE eventType, PEAK_EVENT_CONTROLLER_HANDLE * eventControllerHandle);
    static PEAK_C_API PEAK_EventController_GetInfo(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_EventController_GetNumEventsInQueue(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, size_t * numEventsInQueue);
    static PEAK_C_API PEAK_EventController_GetNumEventsFired(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, uint64_t * numEventsFired);
    static PEAK_C_API PEAK_EventController_GetEventMaxSize(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, size_t * eventMaxSize);
    static PEAK_C_API PEAK_EventController_GetEventDataMaxSize(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, size_t * eventDataMaxSize);
    static PEAK_C_API PEAK_EventController_GetControlledEventType(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, PEAK_EVENT_TYPE * controlledEventType);
    static PEAK_C_API PEAK_EventController_WaitForEvent(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, uint64_t timeout_ms, PEAK_EVENT_HANDLE * eventHandle);
    static PEAK_C_API PEAK_EventController_KillWait(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle);
    static PEAK_C_API PEAK_EventController_FlushEvents(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle);
    static PEAK_C_API PEAK_EventController_Destruct(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle);
    static PEAK_C_API PEAK_Event_GetInfo(PEAK_EVENT_HANDLE eventHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize);
    static PEAK_C_API PEAK_Event_GetID(PEAK_EVENT_HANDLE eventHandle, uint64_t * id);
    static PEAK_C_API PEAK_Event_GetData(PEAK_EVENT_HANDLE eventHandle, uint8_t * data, size_t * dataSize);
    static PEAK_C_API PEAK_Event_GetType(PEAK_EVENT_HANDLE eventHandle, PEAK_EVENT_TYPE * type);
    static PEAK_C_API PEAK_Event_GetRawData(PEAK_EVENT_HANDLE eventHandle, uint8_t * rawData, size_t * rawDataSize);
    static PEAK_C_API PEAK_Event_Destruct(PEAK_EVENT_HANDLE eventHandle);
    static PEAK_C_API PEAK_FirmwareUpdater_Construct(PEAK_FIRMWARE_UPDATER_HANDLE * firmwareUpdaterHandle);
    static PEAK_C_API PEAK_FirmwareUpdater_CollectAllFirmwareUpdateInformation(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, const char * gufPath, size_t gufPathSize);
    static PEAK_C_API PEAK_FirmwareUpdater_CollectFirmwareUpdateInformation(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, const char * gufPath, size_t gufPathSize, PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle);
    static PEAK_C_API PEAK_FirmwareUpdater_GetNumFirmwareUpdateInformation(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, size_t * numFirmwareUpdateInformation);
    static PEAK_C_API PEAK_FirmwareUpdater_GetFirmwareUpdateInformation(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, size_t index, PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE * firmwareUpdateInformationHandle);
    static PEAK_C_API PEAK_FirmwareUpdater_UpdateDevice(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle);
    static PEAK_C_API PEAK_FirmwareUpdater_UpdateDeviceWithResetTimeout(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, uint64_t deviceResetDiscoveryTimeout_ms);
    static PEAK_C_API PEAK_FirmwareUpdater_Destruct(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle);
    static PEAK_C_API PEAK_FirmwareUpdateInformation_GetIsValid(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_BOOL8 * isValid);
    static PEAK_C_API PEAK_FirmwareUpdateInformation_GetFileName(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * fileName, size_t * fileNameSize);
    static PEAK_C_API PEAK_FirmwareUpdateInformation_GetDescription(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * description, size_t * descriptionSize);
    static PEAK_C_API PEAK_FirmwareUpdateInformation_GetVersion(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * version, size_t * versionSize);
    static PEAK_C_API PEAK_FirmwareUpdateInformation_GetVersionExtractionPattern(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * versionExtractionPattern, size_t * versionExtractionPatternSize);
    static PEAK_C_API PEAK_FirmwareUpdateInformation_GetVersionStyle(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_VERSION_STYLE * versionStyle);
    static PEAK_C_API PEAK_FirmwareUpdateInformation_GetReleaseNotes(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * releaseNotes, size_t * releaseNotesSize);
    static PEAK_C_API PEAK_FirmwareUpdateInformation_GetReleaseNotesURL(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * releaseNotesUrl, size_t * releaseNotesUrlSize);
    static PEAK_C_API PEAK_FirmwareUpdateInformation_GetUserSetPersistence(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_PERSISTENCE * userSetPersistence);
    static PEAK_C_API PEAK_FirmwareUpdateInformation_GetSequencerSetPersistence(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_PERSISTENCE * sequencerSetPersistence);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_Construct(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE * firmwareUpdateProgressObserverHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_RegisterUpdateStartedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STARTED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_STARTED_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateStartedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STARTED_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_RegisterUpdateStepStartedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_STARTED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_STEP_STARTED_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateStepStartedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_STARTED_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_RegisterUpdateStepProgressChangedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_PROGRESS_CHANGED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_STEP_PROGRESS_CHANGED_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateStepProgressChangedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_PROGRESS_CHANGED_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_RegisterUpdateStepFinishedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_FINISHED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_STEP_FINISHED_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateStepFinishedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_FINISHED_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_RegisterUpdateFinishedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_FINISHED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_FINISHED_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateFinishedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_FINISHED_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_RegisterUpdateFailedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_FAILED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_FAILED_CALLBACK_HANDLE * callbackHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateFailedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_FAILED_CALLBACK_HANDLE callbackHandle);
    static PEAK_C_API PEAK_FirmwareUpdateProgressObserver_Destruct(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle);
    static PEAK_C_API PEAK_FileAdapter_Construct(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * fileName, PEAK_FILE_ADAPTER_HANDLE * fileAdapterHandle);
    static PEAK_C_API PEAK_FileAdapter_Destruct(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle);
    static PEAK_C_API PEAK_FileAdapter_Read(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, uint64_t size, uint64_t offset, uint8_t * data, uint64_t * dataSize);
    static PEAK_C_API PEAK_FileAdapter_Write(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, const uint8_t * data, uint64_t size, uint64_t offset);
    static PEAK_C_API PEAK_FileAdapter_Delete(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle);
    static PEAK_C_API PEAK_FileAdapter_GetSize(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, uint64_t * size);
    static PEAK_C_API PEAK_FileAdapter_GetMaxSize(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, uint64_t * maxSize);
...
private:
    ...
    dyn_PEAK_Interface_RegisterDeviceReconnectedCallback m_PEAK_Interface_RegisterDeviceReconnectedCallback{};
    dyn_PEAK_Interface_UnregisterDeviceReconnectedCallback m_PEAK_Interface_UnregisterDeviceReconnectedCallback{};
    dyn_PEAK_Interface_RegisterDeviceDisconnectedCallback m_PEAK_Interface_RegisterDeviceDisconnectedCallback{};
    dyn_PEAK_Interface_UnregisterDeviceDisconnectedCallback m_PEAK_Interface_UnregisterDeviceDisconnectedCallback{};
    ...
    dyn_PEAK_Interface_RegisterDeviceListChangedCallback m_PEAK_Interface_RegisterDeviceListChangedCallback{};
    dyn_PEAK_Interface_UnregisterDeviceListChangedCallback m_PEAK_Interface_UnregisterDeviceListChangedCallback{};
    ...
    dyn_PEAK_Buffer_GetHasParts m_PEAK_Buffer_GetHasParts{};
    ...
    dyn_PEAK_BufferChunk_Destruct m_PEAK_BufferChunk_Destruct{};
    ...
    dyn_PEAK_BufferPart_Destruct m_PEAK_BufferPart_Destruct{};
    ...
    dyn_PEAK_NodeMap_TryFindNode m_PEAK_NodeMap_TryFindNode{};
    ...
    dyn_PEAK_EnumerationNode_GetHasEntryBySymbolicValue m_PEAK_EnumerationNode_GetHasEntryBySymbolicValue{};
    dyn_PEAK_EnumerationNode_GetHasEntryByValue m_PEAK_EnumerationNode_GetHasEntryByValue{};
    ...
    dyn_PEAK_EnumerationNode_TryFindEntryBySymbolicValue m_PEAK_EnumerationNode_TryFindEntryBySymbolicValue{};
    dyn_PEAK_EnumerationNode_TryFindEntryByValue m_PEAK_EnumerationNode_TryFindEntryByValue{};
    ...
    dyn_PEAK_FileAdapter_Construct m_PEAK_FileAdapter_Construct{};
    dyn_PEAK_FileAdapter_Destruct m_PEAK_FileAdapter_Destruct{};
    dyn_PEAK_FileAdapter_Read m_PEAK_FileAdapter_Read{};
    dyn_PEAK_FileAdapter_Write m_PEAK_FileAdapter_Write{};
    dyn_PEAK_FileAdapter_Delete m_PEAK_FileAdapter_Delete{};
    dyn_PEAK_FileAdapter_GetSize m_PEAK_FileAdapter_GetSize{};
    dyn_PEAK_FileAdapter_GetMaxSize m_PEAK_FileAdapter_GetMaxSize{};
...
#endif
                    AddDllDirectory(ids_peak_path.c_str());
                }
            }
        }
    }
...
inline bool DynamicLoader::setPointers(bool load)
{
    ...
    m_PEAK_Interface_RegisterDeviceReconnectedCallback = (dyn_PEAK_Interface_RegisterDeviceReconnectedCallback) (load ?  import_function(m_handle, "PEAK_Interface_RegisterDeviceReconnectedCallback") : nullptr);
    if(m_PEAK_Interface_RegisterDeviceReconnectedCallback == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_Interface_RegisterDeviceReconnectedCallback");
    }        

    m_PEAK_Interface_UnregisterDeviceReconnectedCallback = (dyn_PEAK_Interface_UnregisterDeviceReconnectedCallback) (load ?  import_function(m_handle, "PEAK_Interface_UnregisterDeviceReconnectedCallback") : nullptr);
    if(m_PEAK_Interface_UnregisterDeviceReconnectedCallback == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_Interface_UnregisterDeviceReconnectedCallback");
    }        

    m_PEAK_Interface_RegisterDeviceDisconnectedCallback = (dyn_PEAK_Interface_RegisterDeviceDisconnectedCallback) (load ?  import_function(m_handle, "PEAK_Interface_RegisterDeviceDisconnectedCallback") : nullptr);
    if(m_PEAK_Interface_RegisterDeviceDisconnectedCallback == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_Interface_RegisterDeviceDisconnectedCallback");
    }        

    m_PEAK_Interface_UnregisterDeviceDisconnectedCallback = (dyn_PEAK_Interface_UnregisterDeviceDisconnectedCallback) (load ?  import_function(m_handle, "PEAK_Interface_UnregisterDeviceDisconnectedCallback") : nullptr);
    if(m_PEAK_Interface_UnregisterDeviceDisconnectedCallback == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_Interface_UnregisterDeviceDisconnectedCallback");
    }        
    ...
    m_PEAK_Interface_RegisterDeviceListChangedCallback = (dyn_PEAK_Interface_RegisterDeviceListChangedCallback) (load ?  import_function(m_handle, "PEAK_Interface_RegisterDeviceListChangedCallback") : nullptr);
    if(m_PEAK_Interface_RegisterDeviceListChangedCallback == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_Interface_RegisterDeviceListChangedCallback");
    }        

    m_PEAK_Interface_UnregisterDeviceListChangedCallback = (dyn_PEAK_Interface_UnregisterDeviceListChangedCallback) (load ?  import_function(m_handle, "PEAK_Interface_UnregisterDeviceListChangedCallback") : nullptr);
    if(m_PEAK_Interface_UnregisterDeviceListChangedCallback == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_Interface_UnregisterDeviceListChangedCallback");
    }        
    ...
    m_PEAK_Buffer_GetHasParts = (dyn_PEAK_Buffer_GetHasParts) (load ?  import_function(m_handle, "PEAK_Buffer_GetHasParts") : nullptr);
    if(m_PEAK_Buffer_GetHasParts == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_Buffer_GetHasParts");
    }        
    ...
    m_PEAK_BufferChunk_Destruct = (dyn_PEAK_BufferChunk_Destruct) (load ?  import_function(m_handle, "PEAK_BufferChunk_Destruct") : nullptr);
    if(m_PEAK_BufferChunk_Destruct == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_BufferChunk_Destruct");
    }        
    ...
    m_PEAK_BufferPart_Destruct = (dyn_PEAK_BufferPart_Destruct) (load ?  import_function(m_handle, "PEAK_BufferPart_Destruct") : nullptr);
    if(m_PEAK_BufferPart_Destruct == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_BufferPart_Destruct");
    }        
    ...
    m_PEAK_NodeMap_TryFindNode = (dyn_PEAK_NodeMap_TryFindNode) (load ?  import_function(m_handle, "PEAK_NodeMap_TryFindNode") : nullptr);
    if(m_PEAK_NodeMap_TryFindNode == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_NodeMap_TryFindNode");
    }        
    ...
    m_PEAK_EnumerationNode_GetHasEntryBySymbolicValue = (dyn_PEAK_EnumerationNode_GetHasEntryBySymbolicValue) (load ?  import_function(m_handle, "PEAK_EnumerationNode_GetHasEntryBySymbolicValue") : nullptr);
    if(m_PEAK_EnumerationNode_GetHasEntryBySymbolicValue == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_EnumerationNode_GetHasEntryBySymbolicValue");
    }        

    m_PEAK_EnumerationNode_GetHasEntryByValue = (dyn_PEAK_EnumerationNode_GetHasEntryByValue) (load ?  import_function(m_handle, "PEAK_EnumerationNode_GetHasEntryByValue") : nullptr);
    if(m_PEAK_EnumerationNode_GetHasEntryByValue == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_EnumerationNode_GetHasEntryByValue");
    }        
    ...
    m_PEAK_EnumerationNode_TryFindEntryBySymbolicValue = (dyn_PEAK_EnumerationNode_TryFindEntryBySymbolicValue) (load ?  import_function(m_handle, "PEAK_EnumerationNode_TryFindEntryBySymbolicValue") : nullptr);
    if(m_PEAK_EnumerationNode_TryFindEntryBySymbolicValue == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_EnumerationNode_TryFindEntryBySymbolicValue");
    }        

    m_PEAK_EnumerationNode_TryFindEntryByValue = (dyn_PEAK_EnumerationNode_TryFindEntryByValue) (load ?  import_function(m_handle, "PEAK_EnumerationNode_TryFindEntryByValue") : nullptr);
    if(m_PEAK_EnumerationNode_TryFindEntryByValue == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_EnumerationNode_TryFindEntryByValue");
    }        
    ...
    m_PEAK_FileAdapter_Construct = (dyn_PEAK_FileAdapter_Construct) (load ?  import_function(m_handle, "PEAK_FileAdapter_Construct") : nullptr);
    if(m_PEAK_FileAdapter_Construct == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_FileAdapter_Construct");
    }        

    m_PEAK_FileAdapter_Destruct = (dyn_PEAK_FileAdapter_Destruct) (load ?  import_function(m_handle, "PEAK_FileAdapter_Destruct") : nullptr);
    if(m_PEAK_FileAdapter_Destruct == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_FileAdapter_Destruct");
    }        

    m_PEAK_FileAdapter_Read = (dyn_PEAK_FileAdapter_Read) (load ?  import_function(m_handle, "PEAK_FileAdapter_Read") : nullptr);
    if(m_PEAK_FileAdapter_Read == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_FileAdapter_Read");
    }        

    m_PEAK_FileAdapter_Write = (dyn_PEAK_FileAdapter_Write) (load ?  import_function(m_handle, "PEAK_FileAdapter_Write") : nullptr);
    if(m_PEAK_FileAdapter_Write == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_FileAdapter_Write");
    }        

    m_PEAK_FileAdapter_Delete = (dyn_PEAK_FileAdapter_Delete) (load ?  import_function(m_handle, "PEAK_FileAdapter_Delete") : nullptr);
    if(m_PEAK_FileAdapter_Delete == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_FileAdapter_Delete");
    }        

    m_PEAK_FileAdapter_GetSize = (dyn_PEAK_FileAdapter_GetSize) (load ?  import_function(m_handle, "PEAK_FileAdapter_GetSize") : nullptr);
    if(m_PEAK_FileAdapter_GetSize == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_FileAdapter_GetSize");
    }        

    m_PEAK_FileAdapter_GetMaxSize = (dyn_PEAK_FileAdapter_GetMaxSize) (load ?  import_function(m_handle, "PEAK_FileAdapter_GetMaxSize") : nullptr);
    if(m_PEAK_FileAdapter_GetMaxSize == nullptr && load)
    {
        throw std::runtime_error("Failed to load PEAK_FileAdapter_GetMaxSize");
    }        
...
inline PEAK_C_API DynamicLoader::PEAK_Library_Initialize()
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Library_Close()
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Library_IsInitialized(PEAK_BOOL8 * isInitialized)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Library_GetVersionMajor(uint32_t * libraryVersionMajor)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Library_GetVersionMinor(uint32_t * libraryVersionMinor)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Library_GetVersionSubminor(uint32_t * libraryVersionSubminor)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Library_GetLastError(PEAK_RETURN_CODE * lastErrorCode, char * lastErrorDescription, size_t * lastErrorDescriptionSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnvironmentInspector_UpdateCTIPaths()
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnvironmentInspector_GetNumCTIPaths(size_t * numCtiPaths)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnvironmentInspector_GetCTIPath(size_t index, char * ctiPath, size_t * ctiPathSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_ProducerLibrary_Construct(const char * ctiPath, size_t ctiPathSize, PEAK_PRODUCER_LIBRARY_HANDLE * producerLibraryHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_ProducerLibrary_GetKey(PEAK_PRODUCER_LIBRARY_HANDLE producerLibraryHandle, char * key, size_t * keySize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_ProducerLibrary_GetSystem(PEAK_PRODUCER_LIBRARY_HANDLE producerLibraryHandle, PEAK_SYSTEM_DESCRIPTOR_HANDLE * systemDescriptorHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_ProducerLibrary_Destruct(PEAK_PRODUCER_LIBRARY_HANDLE producerLibraryHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_ToModuleDescriptor(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, PEAK_MODULE_DESCRIPTOR_HANDLE * moduleDescriptorHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetKey(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * key, size_t * keySize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetInfo(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetDisplayName(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * displayName, size_t * displayNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetVendorName(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * vendorName, size_t * vendorNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetModelName(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * modelName, size_t * modelNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetVersion(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * version, size_t * versionSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetTLType(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * tlType, size_t * tlTypeSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetCTIFileName(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * ctiFileName, size_t * ctiFileNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetCTIFullPath(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, char * ctiFullPath, size_t * ctiFullPathSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetGenTLVersionMajor(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, uint32_t * gentlVersionMajor)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetGenTLVersionMinor(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, uint32_t * gentlVersionMinor)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetCharacterEncoding(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, PEAK_CHARACTER_ENCODING * characterEncoding)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_GetParentLibrary(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, PEAK_PRODUCER_LIBRARY_HANDLE * producerLibraryHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_SystemDescriptor_OpenSystem(PEAK_SYSTEM_DESCRIPTOR_HANDLE systemDescriptorHandle, PEAK_SYSTEM_HANDLE * systemHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_ToModule(PEAK_SYSTEM_HANDLE systemHandle, PEAK_MODULE_HANDLE * moduleHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_ToEventSupportingModule(PEAK_SYSTEM_HANDLE systemHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetKey(PEAK_SYSTEM_HANDLE systemHandle, char * key, size_t * keySize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetInfo(PEAK_SYSTEM_HANDLE systemHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetID(PEAK_SYSTEM_HANDLE systemHandle, char * id, size_t * idSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetDisplayName(PEAK_SYSTEM_HANDLE systemHandle, char * displayName, size_t * displayNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetVendorName(PEAK_SYSTEM_HANDLE systemHandle, char * vendorName, size_t * vendorNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetModelName(PEAK_SYSTEM_HANDLE systemHandle, char * modelName, size_t * modelNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetVersion(PEAK_SYSTEM_HANDLE systemHandle, char * version, size_t * versionSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetTLType(PEAK_SYSTEM_HANDLE systemHandle, char * tlType, size_t * tlTypeSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetCTIFileName(PEAK_SYSTEM_HANDLE systemHandle, char * ctiFileName, size_t * ctiFileNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetCTIFullPath(PEAK_SYSTEM_HANDLE systemHandle, char * ctiFullPath, size_t * ctiFullPathSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetGenTLVersionMajor(PEAK_SYSTEM_HANDLE systemHandle, uint32_t * gentlVersionMajor)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetGenTLVersionMinor(PEAK_SYSTEM_HANDLE systemHandle, uint32_t * gentlVersionMinor)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetCharacterEncoding(PEAK_SYSTEM_HANDLE systemHandle, PEAK_CHARACTER_ENCODING * characterEncoding)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetParentLibrary(PEAK_SYSTEM_HANDLE systemHandle, PEAK_PRODUCER_LIBRARY_HANDLE * producerLibraryHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_UpdateInterfaces(PEAK_SYSTEM_HANDLE systemHandle, uint64_t timeout_ms)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetNumInterfaces(PEAK_SYSTEM_HANDLE systemHandle, size_t * numInterfaces)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_GetInterface(PEAK_SYSTEM_HANDLE systemHandle, size_t index, PEAK_INTERFACE_DESCRIPTOR_HANDLE * interfaceDescriptorHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_RegisterInterfaceFoundCallback(PEAK_SYSTEM_HANDLE systemHandle, PEAK_INTERFACE_FOUND_CALLBACK callback, void * callbackContext, PEAK_INTERFACE_FOUND_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_UnregisterInterfaceFoundCallback(PEAK_SYSTEM_HANDLE systemHandle, PEAK_INTERFACE_FOUND_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_RegisterInterfaceLostCallback(PEAK_SYSTEM_HANDLE systemHandle, PEAK_INTERFACE_LOST_CALLBACK callback, void * callbackContext, PEAK_INTERFACE_LOST_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_UnregisterInterfaceLostCallback(PEAK_SYSTEM_HANDLE systemHandle, PEAK_INTERFACE_LOST_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_System_Destruct(PEAK_SYSTEM_HANDLE systemHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_InterfaceDescriptor_ToModuleDescriptor(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, PEAK_MODULE_DESCRIPTOR_HANDLE * moduleDescriptorHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_InterfaceDescriptor_GetKey(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, char * key, size_t * keySize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_InterfaceDescriptor_GetInfo(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_InterfaceDescriptor_GetDisplayName(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, char * displayName, size_t * displayNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_InterfaceDescriptor_GetTLType(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, char * tlType, size_t * tlTypeSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_InterfaceDescriptor_GetParentSystem(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, PEAK_SYSTEM_HANDLE * systemHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_InterfaceDescriptor_OpenInterface(PEAK_INTERFACE_DESCRIPTOR_HANDLE interfaceDescriptorHandle, PEAK_INTERFACE_HANDLE * interfaceHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_ToModule(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_MODULE_HANDLE * moduleHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_ToEventSupportingModule(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_GetKey(PEAK_INTERFACE_HANDLE interfaceHandle, char * key, size_t * keySize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_GetInfo(PEAK_INTERFACE_HANDLE interfaceHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_GetID(PEAK_INTERFACE_HANDLE interfaceHandle, char * id, size_t * idSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_GetDisplayName(PEAK_INTERFACE_HANDLE interfaceHandle, char * displayName, size_t * displayNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_GetTLType(PEAK_INTERFACE_HANDLE interfaceHandle, char * tlType, size_t * tlTypeSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_GetParentSystem(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_SYSTEM_HANDLE * systemHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_UpdateDevices(PEAK_INTERFACE_HANDLE interfaceHandle, uint64_t timeout_ms)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_GetNumDevices(PEAK_INTERFACE_HANDLE interfaceHandle, size_t * numDevices)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_GetDevice(PEAK_INTERFACE_HANDLE interfaceHandle, size_t index, PEAK_DEVICE_DESCRIPTOR_HANDLE * deviceDescriptorHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_RegisterDeviceFoundCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_FOUND_CALLBACK callback, void * callbackContext, PEAK_DEVICE_FOUND_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_UnregisterDeviceFoundCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_FOUND_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_RegisterDeviceReconnectedCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_RECONNECTED_CALLBACK callback, void * callbackContext, PEAK_DEVICE_RECONNECTED_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_Interface_RegisterDeviceReconnectedCallback)
    {
        return inst.m_PEAK_Interface_RegisterDeviceReconnectedCallback(interfaceHandle, callback, callbackContext, callbackHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_UnregisterDeviceReconnectedCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_RECONNECTED_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_Interface_UnregisterDeviceReconnectedCallback)
    {
        return inst.m_PEAK_Interface_UnregisterDeviceReconnectedCallback(interfaceHandle, callbackHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_RegisterDeviceDisconnectedCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_DISCONNETED_CALLBACK callback, void * callbackContext, PEAK_DEVICE_DISCONNECTED_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_Interface_RegisterDeviceDisconnectedCallback)
    {
        return inst.m_PEAK_Interface_RegisterDeviceDisconnectedCallback(interfaceHandle, callback, callbackContext, callbackHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_UnregisterDeviceDisconnectedCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_DISCONNECTED_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_Interface_UnregisterDeviceDisconnectedCallback)
    {
        return inst.m_PEAK_Interface_UnregisterDeviceDisconnectedCallback(interfaceHandle, callbackHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_RegisterDeviceLostCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LOST_CALLBACK callback, void * callbackContext, PEAK_DEVICE_LOST_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_UnregisterDeviceLostCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LOST_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_RegisterDeviceListChangedCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LIST_CHANGED_CALLBACK callback, void * callbackContext, PEAK_DEVICE_LIST_CHANGED_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_Interface_RegisterDeviceListChangedCallback)
    {
        return inst.m_PEAK_Interface_RegisterDeviceListChangedCallback(interfaceHandle, callback, callbackContext, callbackHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_UnregisterDeviceListChangedCallback(PEAK_INTERFACE_HANDLE interfaceHandle, PEAK_DEVICE_LIST_CHANGED_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_Interface_UnregisterDeviceListChangedCallback)
    {
        return inst.m_PEAK_Interface_UnregisterDeviceListChangedCallback(interfaceHandle, callbackHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_Interface_Destruct(PEAK_INTERFACE_HANDLE interfaceHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_ToModuleDescriptor(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_MODULE_DESCRIPTOR_HANDLE * moduleDescriptorHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetKey(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * key, size_t * keySize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetInfo(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetDisplayName(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * displayName, size_t * displayNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetVendorName(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * vendorName, size_t * vendorNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetModelName(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * modelName, size_t * modelNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetVersion(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * version, size_t * versionSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetTLType(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * tlType, size_t * tlTypeSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetUserDefinedName(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * userDefinedName, size_t * userDefinedNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetSerialNumber(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, char * serialNumber, size_t * serialNumberSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetAccessStatus(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_ACCESS_STATUS * accessStatus)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetTimestampTickFrequency(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, uint64_t * timestampTickFrequency)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetIsOpenableExclusive(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_BOOL8 * isOpenable)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetIsOpenable(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_ACCESS_TYPE accessType, PEAK_BOOL8 * isOpenable)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_OpenDevice(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_ACCESS_TYPE accessType, PEAK_DEVICE_HANDLE * deviceHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetParentInterface(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_INTERFACE_HANDLE * interfaceHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_GetMonitoringUpdateInterval(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, uint64_t * monitoringUpdateInterval_ms)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_SetMonitoringUpdateInterval(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, uint64_t monitoringUpdateInterval_ms)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_IsInformationRoleMonitored(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_INFORMATION_ROLE informationRole, PEAK_BOOL8 * isInformationRoleMonitored)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_AddInformationRoleToMonitoring(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_INFORMATION_ROLE informationRole)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_RemoveInformationRoleFromMonitoring(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_INFORMATION_ROLE informationRole)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_RegisterInformationChangedCallback(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_DESCRIPTOR_INFORMATION_CHANGED_CALLBACK callback, void * callbackContext, PEAK_DEVICE_DESCRIPTOR_INFORMATION_CHANGED_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DeviceDescriptor_UnregisterInformationChangedCallback(PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_DEVICE_DESCRIPTOR_INFORMATION_CHANGED_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_ToModule(PEAK_DEVICE_HANDLE deviceHandle, PEAK_MODULE_HANDLE * moduleHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_ToEventSupportingModule(PEAK_DEVICE_HANDLE deviceHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetKey(PEAK_DEVICE_HANDLE deviceHandle, char * key, size_t * keySize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetInfo(PEAK_DEVICE_HANDLE deviceHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetID(PEAK_DEVICE_HANDLE deviceHandle, char * id, size_t * idSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetDisplayName(PEAK_DEVICE_HANDLE deviceHandle, char * displayName, size_t * displayNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetVendorName(PEAK_DEVICE_HANDLE deviceHandle, char * vendorName, size_t * vendorNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetModelName(PEAK_DEVICE_HANDLE deviceHandle, char * modelName, size_t * modelNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetVersion(PEAK_DEVICE_HANDLE deviceHandle, char * version, size_t * versionSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetTLType(PEAK_DEVICE_HANDLE deviceHandle, char * tlType, size_t * tlTypeSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetUserDefinedName(PEAK_DEVICE_HANDLE deviceHandle, char * userDefinedName, size_t * userDefinedNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetSerialNumber(PEAK_DEVICE_HANDLE deviceHandle, char * serialNumber, size_t * serialNumberSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetAccessStatus(PEAK_DEVICE_HANDLE deviceHandle, PEAK_DEVICE_ACCESS_STATUS * accessStatus)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetTimestampTickFrequency(PEAK_DEVICE_HANDLE deviceHandle, uint64_t * timestampTickFrequency)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetParentInterface(PEAK_DEVICE_HANDLE deviceHandle, PEAK_INTERFACE_HANDLE * interfaceHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetRemoteDevice(PEAK_DEVICE_HANDLE deviceHandle, PEAK_REMOTE_DEVICE_HANDLE * remoteDeviceHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetNumDataStreams(PEAK_DEVICE_HANDLE deviceHandle, size_t * numDataStreams)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_GetDataStream(PEAK_DEVICE_HANDLE deviceHandle, size_t index, PEAK_DATA_STREAM_DESCRIPTOR_HANDLE * dataStreamDescriptorHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Device_Destruct(PEAK_DEVICE_HANDLE deviceHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_RemoteDevice_ToModule(PEAK_REMOTE_DEVICE_HANDLE remoteDeviceHandle, PEAK_MODULE_HANDLE * moduleHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_RemoteDevice_GetLocalDevice(PEAK_REMOTE_DEVICE_HANDLE remoteDeviceHandle, PEAK_DEVICE_HANDLE * deviceHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStreamDescriptor_ToModuleDescriptor(PEAK_DATA_STREAM_DESCRIPTOR_HANDLE dataStreamDescriptorHandle, PEAK_MODULE_DESCRIPTOR_HANDLE * moduleDescriptorHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStreamDescriptor_GetKey(PEAK_DATA_STREAM_DESCRIPTOR_HANDLE dataStreamDescriptorHandle, char * key, size_t * keySize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStreamDescriptor_GetParentDevice(PEAK_DATA_STREAM_DESCRIPTOR_HANDLE dataStreamDescriptorHandle, PEAK_DEVICE_HANDLE * deviceHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStreamDescriptor_OpenDataStream(PEAK_DATA_STREAM_DESCRIPTOR_HANDLE dataStreamDescriptorHandle, PEAK_DATA_STREAM_HANDLE * dataStreamHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_ToModule(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_MODULE_HANDLE * moduleHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_ToEventSupportingModule(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetKey(PEAK_DATA_STREAM_HANDLE dataStreamHandle, char * key, size_t * keySize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetInfo(PEAK_DATA_STREAM_HANDLE dataStreamHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetID(PEAK_DATA_STREAM_HANDLE dataStreamHandle, char * id, size_t * idSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetTLType(PEAK_DATA_STREAM_HANDLE dataStreamHandle, char * tlType, size_t * tlTypeSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetNumBuffersAnnouncedMinRequired(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numBuffersAnnouncedMinRequired)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetNumBuffersAnnounced(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numBuffersAnnounced)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetNumBuffersQueued(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numBuffersQueued)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetNumBuffersAwaitDelivery(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numBuffersAwaitDelivery)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetNumBuffersDelivered(PEAK_DATA_STREAM_HANDLE dataStreamHandle, uint64_t * numBuffersDelivered)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetNumBuffersStarted(PEAK_DATA_STREAM_HANDLE dataStreamHandle, uint64_t * numBuffersStarted)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetNumUnderruns(PEAK_DATA_STREAM_HANDLE dataStreamHandle, uint64_t * numUnderruns)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetNumChunksPerBufferMax(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * numChunksPerBufferMax)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetBufferAlignment(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * bufferAlignment)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetPayloadSize(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t * payloadSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetDefinesPayloadSize(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_BOOL8 * definesPayloadSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetIsGrabbing(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_BOOL8 * isGrabbing)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_GetParentDevice(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_DEVICE_HANDLE * deviceHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_AnnounceBuffer(PEAK_DATA_STREAM_HANDLE dataStreamHandle, void * buffer, size_t bufferSize, void * userPtr, PEAK_BUFFER_REVOCATION_CALLBACK revocationCallback, void * callbackContext, PEAK_BUFFER_HANDLE * bufferHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_AllocAndAnnounceBuffer(PEAK_DATA_STREAM_HANDLE dataStreamHandle, size_t bufferSize, void * userPtr, PEAK_BUFFER_HANDLE * bufferHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_QueueBuffer(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_BUFFER_HANDLE bufferHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_RevokeBuffer(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_BUFFER_HANDLE bufferHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_WaitForFinishedBuffer(PEAK_DATA_STREAM_HANDLE dataStreamHandle, uint64_t timeout_ms, PEAK_BUFFER_HANDLE * bufferHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_KillWait(PEAK_DATA_STREAM_HANDLE dataStreamHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_Flush(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_DATA_STREAM_FLUSH_MODE flushMode)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_StartAcquisitionInfinite(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_ACQUISITION_START_MODE startMode)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_StartAcquisition(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_ACQUISITION_START_MODE startMode, uint64_t numToAcquire)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_StopAcquisition(PEAK_DATA_STREAM_HANDLE dataStreamHandle, PEAK_ACQUISITION_STOP_MODE stopMode)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_DataStream_Destruct(PEAK_DATA_STREAM_HANDLE dataStreamHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_ToModule(PEAK_BUFFER_HANDLE bufferHandle, PEAK_MODULE_HANDLE * moduleHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_ToEventSupportingModule(PEAK_BUFFER_HANDLE bufferHandle, PEAK_EVENT_SUPPORTING_MODULE_HANDLE * eventSupportingModuleHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetInfo(PEAK_BUFFER_HANDLE bufferHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetTLType(PEAK_BUFFER_HANDLE bufferHandle, char * tlType, size_t * tlTypeSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetBasePtr(PEAK_BUFFER_HANDLE bufferHandle, void * * basePtr)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetSize(PEAK_BUFFER_HANDLE bufferHandle, size_t * size)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetUserPtr(PEAK_BUFFER_HANDLE bufferHandle, void * * userPtr)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetPayloadType(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BUFFER_PAYLOAD_TYPE * payloadType)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetPixelFormat(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * pixelFormat)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetPixelFormatNamespace(PEAK_BUFFER_HANDLE bufferHandle, PEAK_PIXEL_FORMAT_NAMESPACE * pixelFormatNamespace)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetPixelEndianness(PEAK_BUFFER_HANDLE bufferHandle, PEAK_ENDIANNESS * pixelEndianness)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetExpectedDataSize(PEAK_BUFFER_HANDLE bufferHandle, size_t * expectedDataSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetDeliveredDataSize(PEAK_BUFFER_HANDLE bufferHandle, size_t * deliveredDataSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetFrameID(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * frameId)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetImageOffset(PEAK_BUFFER_HANDLE bufferHandle, size_t * imageOffset)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetDeliveredImageHeight(PEAK_BUFFER_HANDLE bufferHandle, size_t * deliveredImageHeight)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetDeliveredChunkPayloadSize(PEAK_BUFFER_HANDLE bufferHandle, size_t * deliveredChunkPayloadSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetChunkLayoutID(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * chunkLayoutId)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetFileName(PEAK_BUFFER_HANDLE bufferHandle, char * fileName, size_t * fileNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetWidth(PEAK_BUFFER_HANDLE bufferHandle, size_t * width)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetHeight(PEAK_BUFFER_HANDLE bufferHandle, size_t * height)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetXOffset(PEAK_BUFFER_HANDLE bufferHandle, size_t * xOffset)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetYOffset(PEAK_BUFFER_HANDLE bufferHandle, size_t * yOffset)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetXPadding(PEAK_BUFFER_HANDLE bufferHandle, size_t * xPadding)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetYPadding(PEAK_BUFFER_HANDLE bufferHandle, size_t * yPadding)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetTimestamp_ticks(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * timestamp_ticks)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetTimestamp_ns(PEAK_BUFFER_HANDLE bufferHandle, uint64_t * timestamp_ns)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetIsQueued(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * isQueued)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetIsAcquiring(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * isAcquiring)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetIsIncomplete(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * isIncomplete)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetHasNewData(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasNewData)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetHasImage(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasImage)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetHasChunks(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasChunks)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetHasParts(PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasParts)
{
    auto& inst = instance();
    if(inst.m_PEAK_Buffer_GetHasParts)
    {
        return inst.m_PEAK_Buffer_GetHasParts(bufferHandle, hasParts);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_UpdateChunks(PEAK_BUFFER_HANDLE bufferHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetNumChunks(PEAK_BUFFER_HANDLE bufferHandle, size_t * numChunks)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetChunk(PEAK_BUFFER_HANDLE bufferHandle, size_t index, PEAK_BUFFER_CHUNK_HANDLE * bufferChunkHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_UpdateParts(PEAK_BUFFER_HANDLE bufferHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetNumParts(PEAK_BUFFER_HANDLE bufferHandle, size_t * numParts)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Buffer_GetPart(PEAK_BUFFER_HANDLE bufferHandle, size_t index, PEAK_BUFFER_PART_HANDLE * bufferPartHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferChunk_GetID(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle, uint64_t * id)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferChunk_GetBasePtr(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle, void * * basePtr)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferChunk_GetSize(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle, size_t * size)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferChunk_GetParentBuffer(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle, PEAK_BUFFER_HANDLE * bufferHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferChunk_Destruct(PEAK_BUFFER_CHUNK_HANDLE bufferChunkHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_BufferChunk_Destruct)
    {
        return inst.m_PEAK_BufferChunk_Destruct(bufferChunkHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetInfo(PEAK_BUFFER_PART_HANDLE bufferPartHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetSourceID(PEAK_BUFFER_PART_HANDLE bufferPartHandle, uint64_t * sourceId)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetBasePtr(PEAK_BUFFER_PART_HANDLE bufferPartHandle, void * * basePtr)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetSize(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * size)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetType(PEAK_BUFFER_PART_HANDLE bufferPartHandle, PEAK_BUFFER_PART_TYPE * type)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetFormat(PEAK_BUFFER_PART_HANDLE bufferPartHandle, uint64_t * format)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetFormatNamespace(PEAK_BUFFER_PART_HANDLE bufferPartHandle, uint64_t * formatNamespace)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetWidth(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * width)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetHeight(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * height)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetXOffset(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * xOffset)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetYOffset(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * yOffset)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetXPadding(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * xPadding)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetDeliveredImageHeight(PEAK_BUFFER_PART_HANDLE bufferPartHandle, size_t * deliveredImageHeight)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_GetParentBuffer(PEAK_BUFFER_PART_HANDLE bufferPartHandle, PEAK_BUFFER_HANDLE * bufferHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BufferPart_Destruct(PEAK_BUFFER_PART_HANDLE bufferPartHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_BufferPart_Destruct)
    {
        return inst.m_PEAK_BufferPart_Destruct(bufferPartHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_ModuleDescriptor_GetID(PEAK_MODULE_DESCRIPTOR_HANDLE moduleDescriptorHandle, char * id, size_t * idSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Module_GetNumNodeMaps(PEAK_MODULE_HANDLE moduleHandle, size_t * numNodeMaps)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Module_GetNodeMap(PEAK_MODULE_HANDLE moduleHandle, size_t index, PEAK_NODE_MAP_HANDLE * nodeMapHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Module_GetPort(PEAK_MODULE_HANDLE moduleHandle, PEAK_PORT_HANDLE * portHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_GetHasNode(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * nodeName, size_t nodeNameSize, PEAK_BOOL8 * hasNode)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_FindNode(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * nodeName, size_t nodeNameSize, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_TryFindNode(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * nodeName, size_t nodeNameSize, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_NodeMap_TryFindNode)
    {
        return inst.m_PEAK_NodeMap_TryFindNode(nodeMapHandle, nodeName, nodeNameSize, nodeHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_InvalidateNodes(PEAK_NODE_MAP_HANDLE nodeMapHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_PollNodes(PEAK_NODE_MAP_HANDLE nodeMapHandle, int64_t elapsedTime_ms)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_GetNumNodes(PEAK_NODE_MAP_HANDLE nodeMapHandle, size_t * numNodes)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_GetNode(PEAK_NODE_MAP_HANDLE nodeMapHandle, size_t index, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_GetHasBufferSupportedChunks(PEAK_NODE_MAP_HANDLE nodeMapHandle, PEAK_BUFFER_HANDLE bufferHandle, PEAK_BOOL8 * hasSupportedChunks)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_UpdateChunkNodes(PEAK_NODE_MAP_HANDLE nodeMapHandle, PEAK_BUFFER_HANDLE bufferHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_GetHasEventSupportedData(PEAK_NODE_MAP_HANDLE nodeMapHandle, PEAK_EVENT_HANDLE eventHandle, PEAK_BOOL8 * hasSupportedData)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_UpdateEventNodes(PEAK_NODE_MAP_HANDLE nodeMapHandle, PEAK_EVENT_HANDLE eventHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_StoreToFile(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * filePath, size_t filePathSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_LoadFromFile(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * filePath, size_t filePathSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_Lock(PEAK_NODE_MAP_HANDLE nodeMapHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_NodeMap_Unlock(PEAK_NODE_MAP_HANDLE nodeMapHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_ToIntegerNode(PEAK_NODE_HANDLE nodeHandle, PEAK_INTEGER_NODE_HANDLE * integerNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_ToBooleanNode(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOLEAN_NODE_HANDLE * booleanNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_ToCommandNode(PEAK_NODE_HANDLE nodeHandle, PEAK_COMMAND_NODE_HANDLE * commandNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_ToFloatNode(PEAK_NODE_HANDLE nodeHandle, PEAK_FLOAT_NODE_HANDLE * floatNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_ToStringNode(PEAK_NODE_HANDLE nodeHandle, PEAK_STRING_NODE_HANDLE * stringNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_ToRegisterNode(PEAK_NODE_HANDLE nodeHandle, PEAK_REGISTER_NODE_HANDLE * registerNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_ToCategoryNode(PEAK_NODE_HANDLE nodeHandle, PEAK_CATEGORY_NODE_HANDLE * categoryNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_ToEnumerationNode(PEAK_NODE_HANDLE nodeHandle, PEAK_ENUMERATION_NODE_HANDLE * enumerationNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_ToEnumerationEntryNode(PEAK_NODE_HANDLE nodeHandle, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetName(PEAK_NODE_HANDLE nodeHandle, char * name, size_t * nameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetDisplayName(PEAK_NODE_HANDLE nodeHandle, char * displayName, size_t * displayNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetNamespace(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_NAMESPACE * _namespace)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetVisibility(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_VISIBILITY * visibility)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetAccessStatus(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_ACCESS_STATUS * accessStatus)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetIsCacheable(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isCacheable)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetIsAccessStatusCacheable(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isAccessStatusCacheable)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetIsStreamable(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isStreamable)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetIsDeprecated(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isDeprecated)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetIsFeature(PEAK_NODE_HANDLE nodeHandle, PEAK_BOOL8 * isFeature)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetCachingMode(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_CACHING_MODE * cachingMode)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetPollingTime(PEAK_NODE_HANDLE nodeHandle, int64_t * pollingTime_ms)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetToolTip(PEAK_NODE_HANDLE nodeHandle, char * toolTip, size_t * toolTipSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetDescription(PEAK_NODE_HANDLE nodeHandle, char * description, size_t * descriptionSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetType(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_TYPE * type)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetParentNodeMap(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_MAP_HANDLE * nodeMapHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_FindInvalidatedNode(PEAK_NODE_HANDLE nodeHandle, const char * name, size_t nameSize, PEAK_NODE_HANDLE * invalidatedNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetNumInvalidatedNodes(PEAK_NODE_HANDLE nodeHandle, size_t * numInvalidatedNodes)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetInvalidatedNode(PEAK_NODE_HANDLE nodeHandle, size_t index, PEAK_NODE_HANDLE * invalidatedNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_FindInvalidatingNode(PEAK_NODE_HANDLE nodeHandle, const char * name, size_t nameSize, PEAK_NODE_HANDLE * invalidatingNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetNumInvalidatingNodes(PEAK_NODE_HANDLE nodeHandle, size_t * numInvalidatingNodes)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetInvalidatingNode(PEAK_NODE_HANDLE nodeHandle, size_t index, PEAK_NODE_HANDLE * invalidatingNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_FindSelectedNode(PEAK_NODE_HANDLE nodeHandle, const char * name, size_t nameSize, PEAK_NODE_HANDLE * selectedNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetNumSelectedNodes(PEAK_NODE_HANDLE nodeHandle, size_t * numSelectedNodes)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetSelectedNode(PEAK_NODE_HANDLE nodeHandle, size_t index, PEAK_NODE_HANDLE * selectedNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_FindSelectingNode(PEAK_NODE_HANDLE nodeHandle, const char * name, size_t nameSize, PEAK_NODE_HANDLE * selectingNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetNumSelectingNodes(PEAK_NODE_HANDLE nodeHandle, size_t * numSelectingNodes)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_GetSelectingNode(PEAK_NODE_HANDLE nodeHandle, size_t index, PEAK_NODE_HANDLE * selectingNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_RegisterChangedCallback(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_CHANGED_CALLBACK callback, void * callbackContext, PEAK_NODE_CHANGED_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Node_UnregisterChangedCallback(PEAK_NODE_HANDLE nodeHandle, PEAK_NODE_CHANGED_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_IntegerNode_ToNode(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_IntegerNode_GetMinimum(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t * minimum)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_IntegerNode_GetMaximum(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t * maximum)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_IntegerNode_GetIncrement(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t * increment)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_IntegerNode_GetIncrementType(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, PEAK_NODE_INCREMENT_TYPE * incrementType)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_IntegerNode_GetValidValues(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t * validValues, size_t * validValuesSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_IntegerNode_GetRepresentation(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, PEAK_NODE_REPRESENTATION * representation)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_IntegerNode_GetUnit(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, char * unit, size_t * unitSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_IntegerNode_GetValue(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, int64_t * value)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_IntegerNode_SetValue(PEAK_INTEGER_NODE_HANDLE integerNodeHandle, int64_t value)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BooleanNode_ToNode(PEAK_BOOLEAN_NODE_HANDLE booleanNodeHandle, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BooleanNode_GetValue(PEAK_BOOLEAN_NODE_HANDLE booleanNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, PEAK_BOOL8 * value)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_BooleanNode_SetValue(PEAK_BOOLEAN_NODE_HANDLE booleanNodeHandle, PEAK_BOOL8 value)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_CommandNode_ToNode(PEAK_COMMAND_NODE_HANDLE commandNodeHandle, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_CommandNode_GetIsDone(PEAK_COMMAND_NODE_HANDLE commandNodeHandle, PEAK_BOOL8 * isDone)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_CommandNode_Execute(PEAK_COMMAND_NODE_HANDLE commandNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_CommandNode_WaitUntilDoneInfinite(PEAK_COMMAND_NODE_HANDLE commandNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_CommandNode_WaitUntilDone(PEAK_COMMAND_NODE_HANDLE commandNodeHandle, uint64_t waitTimeout_ms)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_ToNode(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_GetMinimum(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double * minimum)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_GetMaximum(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double * maximum)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_GetIncrement(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double * increment)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_GetIncrementType(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_INCREMENT_TYPE * incrementType)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_GetValidValues(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double * validValues, size_t * validValuesSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_GetRepresentation(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_REPRESENTATION * representation)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_GetUnit(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, char * unit, size_t * unitSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_GetDisplayNotation(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_DISPLAY_NOTATION * displayNotation)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_GetDisplayPrecision(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, int64_t * displayPrecision)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_GetHasConstantIncrement(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_BOOL8 * hasConstantIncrement)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_GetValue(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, double * value)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FloatNode_SetValue(PEAK_FLOAT_NODE_HANDLE floatNodeHandle, double value)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_StringNode_ToNode(PEAK_STRING_NODE_HANDLE stringNodeHandle, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_StringNode_GetMaximumLength(PEAK_STRING_NODE_HANDLE stringNodeHandle, int64_t * maximumLength)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_StringNode_GetValue(PEAK_STRING_NODE_HANDLE stringNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, char * value, size_t * valueSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_StringNode_SetValue(PEAK_STRING_NODE_HANDLE stringNodeHandle, const char * value, size_t valueSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_RegisterNode_ToNode(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_RegisterNode_GetAddress(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, uint64_t * address)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_RegisterNode_GetLength(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, size_t * length)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_RegisterNode_Read(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, uint8_t * bytesToRead, size_t bytesToReadSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_RegisterNode_Write(PEAK_REGISTER_NODE_HANDLE registerNodeHandle, const uint8_t * bytesToWrite, size_t bytesToWriteSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_CategoryNode_ToNode(PEAK_CATEGORY_NODE_HANDLE categoryNodeHandle, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_CategoryNode_GetNumSubNodes(PEAK_CATEGORY_NODE_HANDLE categoryNodeHandle, size_t * numSubNodes)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_CategoryNode_GetSubNode(PEAK_CATEGORY_NODE_HANDLE categoryNodeHandle, size_t index, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_ToNode(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_GetCurrentEntry(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, PEAK_NODE_CACHE_USE_POLICY cacheUsePolicy, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_SetCurrentEntry(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_SetCurrentEntryBySymbolicValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, const char * symbolicValue, size_t symbolicValueSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_SetCurrentEntryByValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, int64_t value)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_GetHasEntryBySymbolicValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, const char * symbolicValue, size_t symbolicValueSize, PEAK_BOOL8 * hasEntry)
{
    auto& inst = instance();
    if(inst.m_PEAK_EnumerationNode_GetHasEntryBySymbolicValue)
    {
        return inst.m_PEAK_EnumerationNode_GetHasEntryBySymbolicValue(enumerationNodeHandle, symbolicValue, symbolicValueSize, hasEntry);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_GetHasEntryByValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, int64_t value, PEAK_BOOL8 * hasEntry)
{
    auto& inst = instance();
    if(inst.m_PEAK_EnumerationNode_GetHasEntryByValue)
    {
        return inst.m_PEAK_EnumerationNode_GetHasEntryByValue(enumerationNodeHandle, value, hasEntry);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_FindEntryBySymbolicValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, const char * symbolicValue, size_t symbolicValueSize, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_FindEntryByValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, int64_t value, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_TryFindEntryBySymbolicValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, const char * symbolicValue, size_t symbolicValueSize, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_EnumerationNode_TryFindEntryBySymbolicValue)
    {
        return inst.m_PEAK_EnumerationNode_TryFindEntryBySymbolicValue(enumerationNodeHandle, symbolicValue, symbolicValueSize, enumerationEntryNodeHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_TryFindEntryByValue(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, int64_t value, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_EnumerationNode_TryFindEntryByValue)
    {
        return inst.m_PEAK_EnumerationNode_TryFindEntryByValue(enumerationNodeHandle, value, enumerationEntryNodeHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_GetNumEntries(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, size_t * numEntries)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationNode_GetEntry(PEAK_ENUMERATION_NODE_HANDLE enumerationNodeHandle, size_t index, PEAK_ENUMERATION_ENTRY_NODE_HANDLE * enumerationEntryNodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationEntryNode_ToNode(PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle, PEAK_NODE_HANDLE * nodeHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationEntryNode_GetIsSelfClearing(PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle, PEAK_BOOL8 * isSelfClearing)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationEntryNode_GetSymbolicValue(PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle, char * symbolicValue, size_t * symbolicValueSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EnumerationEntryNode_GetValue(PEAK_ENUMERATION_ENTRY_NODE_HANDLE enumerationEntryNodeHandle, int64_t * value)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetInfo(PEAK_PORT_HANDLE portHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetID(PEAK_PORT_HANDLE portHandle, char * id, size_t * idSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetName(PEAK_PORT_HANDLE portHandle, char * name, size_t * nameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetVendorName(PEAK_PORT_HANDLE portHandle, char * vendorName, size_t * vendorNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetModelName(PEAK_PORT_HANDLE portHandle, char * modelName, size_t * modelNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetVersion(PEAK_PORT_HANDLE portHandle, char * version, size_t * versionSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetTLType(PEAK_PORT_HANDLE portHandle, char * tlType, size_t * tlTypeSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetModuleName(PEAK_PORT_HANDLE portHandle, char * moduleName, size_t * moduleNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetDataEndianness(PEAK_PORT_HANDLE portHandle, PEAK_ENDIANNESS * dataEndianness)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetIsReadable(PEAK_PORT_HANDLE portHandle, PEAK_BOOL8 * isReadable)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetIsWritable(PEAK_PORT_HANDLE portHandle, PEAK_BOOL8 * isWritable)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetIsAvailable(PEAK_PORT_HANDLE portHandle, PEAK_BOOL8 * isAvailable)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetIsImplemented(PEAK_PORT_HANDLE portHandle, PEAK_BOOL8 * isImplemented)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_Read(PEAK_PORT_HANDLE portHandle, uint64_t address, uint8_t * bytesToRead, size_t bytesToReadSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_Write(PEAK_PORT_HANDLE portHandle, uint64_t address, const uint8_t * bytesToWrite, size_t bytesToWriteSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetNumURLs(PEAK_PORT_HANDLE portHandle, size_t * numUrls)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Port_GetURL(PEAK_PORT_HANDLE portHandle, size_t index, PEAK_PORT_URL_HANDLE * portUrlHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetInfo(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetURL(PEAK_PORT_URL_HANDLE portUrlHandle, char * url, size_t * urlSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetScheme(PEAK_PORT_URL_HANDLE portUrlHandle, PEAK_PORT_URL_SCHEME * scheme)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetFileName(PEAK_PORT_URL_HANDLE portUrlHandle, char * fileName, size_t * fileNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetFileRegisterAddress(PEAK_PORT_URL_HANDLE portUrlHandle, uint64_t * fileRegisterAddress)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetFileSize(PEAK_PORT_URL_HANDLE portUrlHandle, uint64_t * fileSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetFileSHA1Hash(PEAK_PORT_URL_HANDLE portUrlHandle, uint8_t * fileSha1Hash, size_t * fileSha1HashSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetFileVersionMajor(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileVersionMajor)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetFileVersionMinor(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileVersionMinor)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetFileVersionSubminor(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileVersionSubminor)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetFileSchemaVersionMajor(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileSchemaVersionMajor)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetFileSchemaVersionMinor(PEAK_PORT_URL_HANDLE portUrlHandle, int32_t * fileSchemaVersionMinor)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_PortURL_GetParentPort(PEAK_PORT_URL_HANDLE portUrlHandle, PEAK_PORT_HANDLE * portHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EventSupportingModule_EnableEvents(PEAK_EVENT_SUPPORTING_MODULE_HANDLE eventSupportingModuleHandle, PEAK_EVENT_TYPE eventType, PEAK_EVENT_CONTROLLER_HANDLE * eventControllerHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EventController_GetInfo(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EventController_GetNumEventsInQueue(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, size_t * numEventsInQueue)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EventController_GetNumEventsFired(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, uint64_t * numEventsFired)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EventController_GetEventMaxSize(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, size_t * eventMaxSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EventController_GetEventDataMaxSize(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, size_t * eventDataMaxSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EventController_GetControlledEventType(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, PEAK_EVENT_TYPE * controlledEventType)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EventController_WaitForEvent(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle, uint64_t timeout_ms, PEAK_EVENT_HANDLE * eventHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EventController_KillWait(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EventController_FlushEvents(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_EventController_Destruct(PEAK_EVENT_CONTROLLER_HANDLE eventControllerHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Event_GetInfo(PEAK_EVENT_HANDLE eventHandle, int32_t infoCommand, int32_t * infoDataType, uint8_t * info, size_t * infoSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Event_GetID(PEAK_EVENT_HANDLE eventHandle, uint64_t * id)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Event_GetData(PEAK_EVENT_HANDLE eventHandle, uint8_t * data, size_t * dataSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Event_GetType(PEAK_EVENT_HANDLE eventHandle, PEAK_EVENT_TYPE * type)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Event_GetRawData(PEAK_EVENT_HANDLE eventHandle, uint8_t * rawData, size_t * rawDataSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_Event_Destruct(PEAK_EVENT_HANDLE eventHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdater_Construct(PEAK_FIRMWARE_UPDATER_HANDLE * firmwareUpdaterHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdater_CollectAllFirmwareUpdateInformation(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, const char * gufPath, size_t gufPathSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdater_CollectFirmwareUpdateInformation(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, const char * gufPath, size_t gufPathSize, PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdater_GetNumFirmwareUpdateInformation(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, size_t * numFirmwareUpdateInformation)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdater_GetFirmwareUpdateInformation(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, size_t index, PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE * firmwareUpdateInformationHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdater_UpdateDevice(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdater_UpdateDeviceWithResetTimeout(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle, PEAK_DEVICE_DESCRIPTOR_HANDLE deviceDescriptorHandle, PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, uint64_t deviceResetDiscoveryTimeout_ms)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdater_Destruct(PEAK_FIRMWARE_UPDATER_HANDLE firmwareUpdaterHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateInformation_GetIsValid(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_BOOL8 * isValid)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateInformation_GetFileName(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * fileName, size_t * fileNameSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateInformation_GetDescription(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * description, size_t * descriptionSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateInformation_GetVersion(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * version, size_t * versionSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateInformation_GetVersionExtractionPattern(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * versionExtractionPattern, size_t * versionExtractionPatternSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateInformation_GetVersionStyle(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_VERSION_STYLE * versionStyle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateInformation_GetReleaseNotes(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * releaseNotes, size_t * releaseNotesSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateInformation_GetReleaseNotesURL(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, char * releaseNotesUrl, size_t * releaseNotesUrlSize)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateInformation_GetUserSetPersistence(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_PERSISTENCE * userSetPersistence)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateInformation_GetSequencerSetPersistence(PEAK_FIRMWARE_UPDATE_INFORMATION_HANDLE firmwareUpdateInformationHandle, PEAK_FIRMWARE_UPDATE_PERSISTENCE * sequencerSetPersistence)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateProgressObserver_Construct(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE * firmwareUpdateProgressObserverHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateStartedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STARTED_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateProgressObserver_RegisterUpdateStepStartedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_STARTED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_STEP_STARTED_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateStepStartedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_STARTED_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateProgressObserver_RegisterUpdateStepProgressChangedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_PROGRESS_CHANGED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_STEP_PROGRESS_CHANGED_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateStepProgressChangedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_PROGRESS_CHANGED_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateProgressObserver_RegisterUpdateStepFinishedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_FINISHED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_STEP_FINISHED_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateStepFinishedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_STEP_FINISHED_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateProgressObserver_RegisterUpdateFinishedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_FINISHED_CALLBACK callback, void * callbackContext, PEAK_FIRMWARE_UPDATE_FINISHED_CALLBACK_HANDLE * callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateFinishedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_FINISHED_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateProgressObserver_UnregisterUpdateFailedCallback(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle, PEAK_FIRMWARE_UPDATE_FAILED_CALLBACK_HANDLE callbackHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FirmwareUpdateProgressObserver_Destruct(PEAK_FIRMWARE_UPDATE_PROGRESS_OBSERVER_HANDLE firmwareUpdateProgressObserverHandle)
{
    auto& inst = instance();
...
inline PEAK_C_API DynamicLoader::PEAK_FileAdapter_Construct(PEAK_NODE_MAP_HANDLE nodeMapHandle, const char * fileName, PEAK_FILE_ADAPTER_HANDLE * fileAdapterHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_FileAdapter_Construct)
    {
        return inst.m_PEAK_FileAdapter_Construct(nodeMapHandle, fileName, fileAdapterHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_FileAdapter_Destruct(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_FileAdapter_Destruct)
    {
        return inst.m_PEAK_FileAdapter_Destruct(fileAdapterHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_FileAdapter_Read(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, uint64_t size, uint64_t offset, uint8_t * data, uint64_t * dataSize)
{
    auto& inst = instance();
    if(inst.m_PEAK_FileAdapter_Read)
    {
        return inst.m_PEAK_FileAdapter_Read(fileAdapterHandle, size, offset, data, dataSize);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_FileAdapter_Write(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, const uint8_t * data, uint64_t size, uint64_t offset)
{
    auto& inst = instance();
    if(inst.m_PEAK_FileAdapter_Write)
    {
        return inst.m_PEAK_FileAdapter_Write(fileAdapterHandle, data, size, offset);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_FileAdapter_Delete(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle)
{
    auto& inst = instance();
    if(inst.m_PEAK_FileAdapter_Delete)
    {
        return inst.m_PEAK_FileAdapter_Delete(fileAdapterHandle);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_FileAdapter_GetSize(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, uint64_t * size)
{
    auto& inst = instance();
    if(inst.m_PEAK_FileAdapter_GetSize)
    {
        return inst.m_PEAK_FileAdapter_GetSize(fileAdapterHandle, size);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
...
inline PEAK_C_API DynamicLoader::PEAK_FileAdapter_GetMaxSize(PEAK_FILE_ADAPTER_HANDLE fileAdapterHandle, uint64_t * maxSize)
{
    auto& inst = instance();
    if(inst.m_PEAK_FileAdapter_GetMaxSize)
    {
        return inst.m_PEAK_FileAdapter_GetMaxSize(fileAdapterHandle, maxSize);
    }
    else
    {
        throw std::runtime_error("Library not loaded!");
