...
inline std::string ReturnCodeToString(PEAK_RETURN_CODE entry)
{
    ...
    case PEAK_RETURN_CODE_CTI_LOADING_ERROR:
        return "PEAK_RETURN_CODE_CTI_LOADING_ERROR";
    case PEAK_RETURN_CODE_IO:
        return "PEAK_RETURN_CODE_IO";
    case PEAK_RETURN_CODE_NO_DATA:
        return "PEAK_RETURN_CODE_NO_DATA";
    }
...
void ExecuteAndMapReturnCodes(const CallableType& callableObject)
{
    if (callableObject() != PEAK_RETURN_CODE_SUCCESS)
    {
        ...
        case PEAK_RETURN_CODE_CTI_LOADING_ERROR:
            throw CTILoadingException(errorText.str());
        case PEAK_RETURN_CODE_IO:
            throw IOException(errorText.str());
        case PEAK_RETURN_CODE_NO_DATA:
            throw NoDataException(errorText.str());
        }
