...
public:
    ...
    /*!
     * \brief Checks whether the buffer contains parts.
     *
...
inline bool Buffer::HasParts() const
{
    return QueryNumericFromCInterfaceFunction<PEAK_BOOL8>([&](PEAK_BOOL8* hasParts) {
        return PEAK_C_ABI_PREFIX PEAK_Buffer_GetHasParts(m_backendHandle, hasParts);
    }) > 0;
}
