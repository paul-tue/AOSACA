...
public:
    ...
    /*!
     * \brief Returns whether the node is currently readable.
     *
     * \throws IOException A communication error has occurred, e.g. when the device is disconnected.
     * \throws InternalErrorException An internal error has occurred.
     *
     * \since 1.8.1
     */
    ...
    /*!
     * \brief Returns whether the node is currently writeable.
     *
     * \throws IOException A communication error has occurred, e.g. when the device is disconnected.
     * \throws InternalErrorException An internal error has occurred.
     *
    ...
    /*!
     * \brief Returns whether the node is currently either readable or writeable.
     *
     * \throws IOException A communication error has occurred, e.g. when the device is disconnected.
     * \throws InternalErrorException An internal error has occurred.
     *
    ...
    /*!
     * \brief Returns whether the node is implemented.
     *
     * \throws IOException A communication error has occurred, e.g. when the device is disconnected.
     * \throws InternalErrorException An internal error has occurred.
     *
...
inline bool Node::IsReadable() const
{
    const auto accessStatus = AccessStatus();
    return accessStatus == NodeAccessStatus::ReadOnly || accessStatus == NodeAccessStatus::ReadWrite;
}

inline bool Node::IsWriteable() const
{
    const auto accessStatus = AccessStatus();
    return accessStatus == NodeAccessStatus::WriteOnly || accessStatus == NodeAccessStatus::ReadWrite;
}

inline bool Node::IsAvailable() const
{
    const auto accessStatus = AccessStatus();
    return accessStatus != NodeAccessStatus::NotImplemented && accessStatus != NodeAccessStatus::NotAvailable;
}

inline bool Node::IsImplemented() const
{
    const auto accessStatus = AccessStatus();
    return accessStatus != NodeAccessStatus::NotImplemented;
}
